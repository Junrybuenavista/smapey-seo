...
const TESTIMONIALS = [
  {
    ...
    quote: "I used to track everything in notebooks and group chats. With Smapey I can see all my members, renewals, and revenue in one place. Setup took maybe 20 minutes.",
  },
  {
    name: "Rodel Aquino",
    role: "Car Rental Operator, Davao",
    avatar: "RA",
    color: "bg-orange-500",
    quote: "I only have 12 cars but I was losing track of who had what and when they were coming back. Smapey fixed that immediately. It's simple enough that my staff learned it in a day.",
  },
  {
    name: "Clara Reyes",
    ...
    avatar: "CR",
    color: "bg-blue-500",
    quote: "I hated invoicing. I kept forgetting to follow up on payments. Now I create an invoice in 2 minutes and I can see exactly who hasn't paid — no spreadsheet needed.",
  },
]
