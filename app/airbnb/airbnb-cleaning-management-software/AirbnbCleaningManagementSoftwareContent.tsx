...
import {
  Home, CalendarRange, BedDouble, BarChart3, ShieldCheck, Users,
...
const FEATURES = [
  {
    icon: BedDouble,
    title: "Checkout Status Tracking",
    desc: "Every reservation that reaches Checked Out is immediately visible on the dashboard. Filter by Checked Out status to see exactly which properties need a turnover right now.",
    color: "from-sky-600 to-blue-400",
    shadow: "shadow-sky-500/20",
  },
  {
    icon: CalendarRange,
    title: "Upcoming Check-in Visibility",
    desc: "The dashboard shows upcoming check-ins so you know which units need to be guest-ready within the next 24–48 hours. No manual calendar cross-checking.",
    color: "from-blue-600 to-sky-400",
    shadow: "shadow-blue-500/20",
  },
  {
    icon: Home,
    title: "Staff Notes per Reservation",
    desc: "Every reservation has a Staff Notes field — invisible to guests, visible only to your team. Log cleaning instructions, turnover checklists, or special requests from the incoming guest.",
    color: "from-sky-500 to-cyan-400",
    shadow: "shadow-sky-500/20",
  },
  {
    icon: ShieldCheck,
    title: "Same-Day Conflict Detection",
    desc: "Double-booking protection also means preventing a cleaning crew crunch — the system won't let you create a same-day arrival before the previous checkout is confirmed.",
  ...
  },
  {
    ...
    desc: "On Pro and Enterprise plans, add cleaners or co-hosts as team members with limited access. They see only what they need — no access to billing, pricing, or guest financial data.",
    color: "from-sky-600 to-indigo-400",
    shadow: "shadow-sky-600/20",
  },
  {
    icon: BarChart3,
    title: "Occupancy Rate Dashboard",
    desc: "High occupancy means tighter cleaning windows. The live dashboard shows your current occupancy rate so you can plan your cleaning schedule around your busiest periods.",
...
const STEPS = [
  { num: "01", title: "Check the Checked Out filter", desc: "After a guest checks out, filter Reservations by Checked Out status. Every property that needs a turnover appears in one list, sorted by checkout date." },
  { num: "02", title: "Review the Staff Notes", desc: "Open each reservation to read the Staff Notes — cleaning instructions, damage reports, or special setup requests for the next guest." },
  { num: "03", title: "Confirm the upcoming arrival", desc: "Check the next reservation for that property to see the check-in date, number of guests, and any notes from the incoming booking." },
  { num: "04", title: "Mark the property ready", desc: "Once cleaning is done and the unit is ready, your team can confirm the next reservation as ready to check in — no back-and-forth messages needed." },
]
...
const COMPARISON = [
  ...
  { feature: "Staff Notes per reservation", free: true, pro: true, enterprise: true },
  { feature: "Checkout status filter", free: true, pro: true, enterprise: true },
  { feature: "Upcoming check-in dashboard", free: true, pro: true, enterprise: true },
...
const FAQS = [
  {
    q: "Does Smapey have a dedicated cleaning schedule feature?",
    a: "Not as a standalone module — Smapey tracks cleaning through the reservation lifecycle. When a reservation is Checked Out, the property needs a turnover. The Checked Out filter and Staff Notes cover most cleaning coordination without a separate schedule tool.",
  },
  {
    q: "How do I track which properties have been cleaned?",
    a: "Use the Staff Notes field on the outgoing reservation to log cleaning completion. When the next reservation is confirmed ready, your team knows the unit is prepared. For multi-property operations, filter by Checked Out status daily to see the full turnover queue.",
  },
  {
    q: "Can I give my cleaner access to the dashboard?",
    a: "Yes. On Pro and Enterprise plans, add team members with limited permissions. Role-based access means your cleaner can see reservation notes and dates without touching billing or guest financial records.",
  },
  {
    q: "What happens between a checkout and the next check-in?",
    a: "The reservation status sits at Checked Out until the next reservation is created. The upcoming check-in on the dashboard shows you the gap — and the Staff Notes field on both reservations is where you coordinate the turnover.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          Track turnovers and keep every{" "}
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Know exactly which properties need a cleaning turnover, when the next guest arrives, and what your cleaner needs to know — all from the reservation dashboard.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <a href="/airbnb/guide" className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white/70 hover:text-white font-medium text-sm transition-all border border-white/10">
            Read the guide
          </a>
        </div>
    ...
    <section className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          <p className="text-sky-600 text-sm font-semibold uppercase tracking-widest mb-3">Cleaning workflow</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Four steps to a clean turnover
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            No separate cleaning app needed. Smapey's reservation system covers the whole turnaround workflow.
          </p>
        </Animate>
    ...
    <section className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Tools that keep your properties clean and ready
          </h2>
        </Animate>
    ...
    <section className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4">Start free and upgrade only when you need more properties or team members.</p>
        </Animate>
        <Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Keep every property guest-ready
        </h2>
        <p className="text-white/40 mb-8">Free forever. No card. Track checkouts, schedule turnovers, and see upcoming check-ins from one dashboard.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=AIRBNB&plan=FREE`}
...
export default function AirbnbCleaningManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="airbnb" currentPath="/airbnb/airbnb-cleaning-management-software" />
      <Footer />
    </main>
  )
}
