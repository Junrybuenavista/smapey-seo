...
const FAQS = [
  ...
  { q: "Can I start for free?", a: "Yes. The free plan includes 3 properties, 20 reservations per month, and full access to the dashboard — no credit card, no trial expiry." },
]
    ...
    <section className="py-24" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight" style={{ color: INK }}>Everything your rental needs in one place</h2>
          <p className="mt-4 max-w-xl mx-auto" style={{ color: "#54514c" }}>Smapey replaces the mix of spreadsheets, notes apps, and calendar reminders most hosts use.</p>
        </Animate>
  ...
  return (
    <section className="py-24 px-6" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <Animate className="relative max-w-3xl mx-auto rounded-[30px] border-2 p-12 md:p-16 text-center" style={{ background: AMBER, borderColor: INK, boxShadow: `10px 10px 0 ${INK}` }}>
        <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-4" style={{ color: INK }}>The Airbnb management software that works the way you do</h2>
        <p className="mb-8 font-medium" style={{ color: "#5c4a28" }}>Free forever. No card. List your properties and start tracking reservations in minutes.</p>
