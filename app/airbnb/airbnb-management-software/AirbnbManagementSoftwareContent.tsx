...
import {
  Home, Users, CalendarRange, ShieldCheck, BarChart3, Sparkles,
...
const FEATURES = [
  {
    ...
    desc: "List every rental with photos, property type, room count, nightly rate, and cleaning fee. Toggle properties on or off as availability changes.",
  ...
  },
  {
    ...
    desc: "Maintain full guest profiles with contact info, stay history, total spent, and personal notes. Reuse profiles across every reservation without re-entering data.",
  ...
  },
  {
    ...
    desc: "Create reservations with date range, cost breakdown, deposit tracking, booking source, and payment status. All in one form, without switching tools.",
  ...
  },
  {
    ...
    desc: "Smapey checks for conflicting reservations on the same property before saving. Overlapping bookings are blocked automatically — no manual cross-checking needed.",
  ...
  },
  {
    ...
    desc: "Tag each booking's source — Airbnb, Booking.com, Agoda, Direct, Facebook, or Referral. Understand which channels fill your calendar and which ones underperform.",
  ...
  },
  {
    ...
    desc: "A live dashboard showing monthly revenue, occupancy rate, total reservations, average nightly rate, and upcoming check-ins — no spreadsheet required.",
...
const FAQS = [
  {
    q: "What does Airbnb management software actually do?",
    a: "It replaces the spreadsheets and manual notes most hosts use to track their properties, guests, and bookings. Good software centralizes reservation creation, check-in/check-out status, payment tracking, and revenue reporting in one dashboard.",
  },
  {
    q: "Is Smapey only for Airbnb listings?",
    a: "No. Smapey tracks bookings from any source — Airbnb, Booking.com, Agoda, Direct, Facebook, Referral, or Other. It's useful for any short-term or transient rental host regardless of where their bookings come from.",
  },
  {
    q: "How does Smapey prevent double bookings?",
    a: "When you create a reservation, the system checks whether the chosen property has any confirmed overlapping bookings for those dates. If a conflict exists, the booking is blocked before it saves.",
  },
  {
    q: "Can I start for free?",
    a: "Yes. The free plan includes 3 properties, 20 reservations per month, and full access to the dashboard — no credit card, no trial expiry.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The Airbnb management software{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-blue-300 to-cyan-300">
            that handles the admin side
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Properties, guests, reservations, deposits, and revenue analytics — all in one dashboard. Stop managing your rental from spreadsheets and WhatsApp threads.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Everything your rental needs in one place
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Smapey replaces the mix of spreadsheets, notes apps, and calendar reminders most hosts use.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          The Airbnb management software that works the way you do
        </h2>
        <p className="text-white/40 mb-8">Free forever. No card. List your properties and start tracking reservations in minutes.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=AIRBNB&plan=FREE`}
...
export default function AirbnbManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="airbnb" currentPath="/airbnb/airbnb-management-software" />
      <Footer />
    </main>
  )
}
