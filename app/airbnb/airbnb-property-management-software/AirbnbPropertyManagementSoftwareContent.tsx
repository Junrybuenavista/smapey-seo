...
const FAQS = [
  { q: "Can I manage multiple Airbnb properties from one account?", a: "Yes. Each property gets its own listing with photos, pricing, and room details. The free plan supports 3 properties, Pro supports 10, and Enterprise is unlimited." },
  ...
  return (
    <section className="py-24 px-6" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <Animate className="relative max-w-3xl mx-auto rounded-[30px] border-2 p-12 md:p-16 text-center" style={{ background: AMBER, borderColor: INK, boxShadow: `10px 10px 0 ${INK}` }}>
        <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-4" style={{ color: INK }}>Manage all your properties from one place</h2>
        <p className="mb-8 font-medium" style={{ color: "#5c4a28" }}>Free forever. No card. Start listing your properties in minutes.</p>
