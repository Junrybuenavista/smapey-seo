...
import {
  Home, Users, CalendarRange, ShieldCheck, BarChart3, Wallet,
...
const FEATURES = [
  {
    ...
    desc: "List every unit with its own photos, property type, address, room counts, nightly rate, and cleaning fee. The Pro plan supports 10 properties; Enterprise is unlimited.",
  ...
  },
  {
    ...
    desc: "The system validates date ranges against all confirmed reservations for that property. Overlapping bookings are rejected before they save — no more uncomfortable double-booking calls.",
    color: "from-cyan-500 to-sky-400",
    shadow: "shadow-cyan-500/20",
  },
  {
    icon: CalendarRange,
    title: "Reservation Per Property",
    desc: "Each reservation is tied to a specific property. Filter the reservation list by property to see exactly what's booked, checked in, or available on any date.",
    color: "from-sky-500 to-cyan-400",
    shadow: "shadow-sky-500/20",
  },
  {
    icon: Users,
    title: "Guest History Per Property",
    desc: "See which guests have stayed at each property. Guest profiles track total stays and spend across all your properties — useful for returning guest discounts.",
    color: "from-blue-600 to-sky-400",
    shadow: "shadow-blue-500/20",
  },
  {
    icon: Wallet,
    title: "Per-Reservation Cost Breakdown",
    desc: "Every reservation auto-calculates: nights × nightly rate + cleaning fee + extra charges. Deposit tracking and payment status are per-reservation, not per property.",
    color: "from-sky-600 to-indigo-400",
    shadow: "shadow-sky-600/20",
  },
  {
    icon: BarChart3,
    title: "Occupancy & Revenue Dashboard",
    desc: "Monthly revenue and occupancy rate roll up across all your properties. See your full portfolio's performance at a glance from one live dashboard.",
...
const COMPARISON = [
  ...
  { feature: "Per-property photo upload", free: true, pro: true, enterprise: true },
  { feature: "Double-booking protection", free: true, pro: true, enterprise: true },
  { feature: "Guest stay history", free: true, pro: true, enterprise: true },
...
const FAQS = [
  {
    q: "Can I manage multiple Airbnb properties from one account?",
    a: "Yes. Each property gets its own listing with photos, pricing, and room details. The free plan supports 3 properties, Pro supports 10, and Enterprise is unlimited.",
  },
  {
    q: "How do I see which properties are available on a given date?",
    a: "Filter the Reservations list by property and status. You can quickly see what's booked, checked in, or open for a specific unit without checking a separate calendar.",
  },
  {
    q: "Does each property have its own cleaning fee?",
    a: "Yes. Each property carries its own nightly rate and cleaning fee. When a reservation is created for that property, the cleaning fee is automatically included in the total cost.",
  },
  {
    q: "What's the difference between Pro and Enterprise?",
    a: "Pro supports 10 properties and 3 team users with unlimited reservations. Enterprise removes all limits — unlimited properties, users, and reservations — plus priority support.",
  },
]
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 via-blue-300 to-cyan-300">
            for independent hosts
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Track every property, guest, and booking from a single dashboard. Know your occupancy rate, revenue per property, and upcoming check-ins — without a single spreadsheet.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Track every property from one dashboard
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Property listings, double-booking protection, occupancy analytics, and guest history — built for hosts managing multiple units.
          </p>
        </Animate>
    ...
    <section className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4">Start free and upgrade when your portfolio grows.</p>
        </Animate>
        <Animate>
  ...
  return (
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        ...
        <p className="text-white/40 mb-8">Free forever. No card. Start listing your properties in minutes.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=AIRBNB&plan=FREE`}
...
export default function AirbnbPropertyManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="airbnb" currentPath="/airbnb/airbnb-property-management-software" />
      <Footer />
    </main>
  )
}
