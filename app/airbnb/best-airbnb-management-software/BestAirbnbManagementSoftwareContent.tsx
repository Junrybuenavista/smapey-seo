...
import {
  Home, ShieldCheck, BarChart3, Sparkles, Wallet, Users,
...
const CRITERIA = [
  {
    ...
    desc: "The single most costly mistake in short-term rentals. The best software blocks overlapping reservations automatically — you should never have to cross-check dates manually.",
  ...
  },
  {
    ...
    desc: "If you manage more than one unit, your software needs to keep each property's availability, pricing, and bookings completely separate — with one unified revenue view.",
    color: "from-blue-600 to-sky-400",
    shadow: "shadow-blue-500/20",
  },
  {
    icon: Sparkles,
    title: "Multi-channel source tracking",
    desc: "Bookings come from Airbnb, Booking.com, Agoda, Facebook, and direct inquiries. Good software lets you tag each source so you know which channels are worth your marketing spend.",
    color: "from-sky-500 to-cyan-400",
    shadow: "shadow-sky-500/20",
  },
  {
    icon: Wallet,
    title: "Deposit and payment tracking",
    desc: "Every host collects deposits. Your software should track the deposit amount, whether it was paid, and the final payment status — per reservation, not as a rough note.",
    color: "from-cyan-500 to-sky-400",
    shadow: "shadow-cyan-500/20",
  },
  {
    icon: Users,
    title: "Guest profiles with history",
    desc: "Returning guests are your best guests. The best software keeps a guest database with stay count, total spent, and contact info — searchable, not buried in old messages.",
    color: "from-sky-600 to-indigo-400",
    shadow: "shadow-sky-600/20",
  },
  {
    icon: BarChart3,
    title: "Occupancy and revenue analytics",
    desc: "You need to know your monthly revenue and occupancy rate without building a spreadsheet. A live dashboard that updates on every check-in and checkout is non-negotiable.",
...
const COMPARISON = [
  ...
  { feature: "Deposit & payment tracking", free: true, pro: true, enterprise: true },
...
const FAQS = [
  {
    q: "What makes Smapey the best Airbnb management software for small hosts?",
    a: "Smapey focuses on what independent hosts actually need: a place to track their properties, guests, and bookings without paying for features built for hotel chains. It's free to start, simple to set up, and covers double-booking protection, payment tracking, and revenue analytics out of the box.",
  },
  {
    q: "How does Smapey compare to channel managers?",
    a: "Channel managers sync your calendar across Airbnb, Booking.com, and other OTAs automatically. Smapey doesn't sync channels — instead, it's a single dashboard where you manually log each reservation after it's confirmed, regardless of which platform it came from. It's best for hosts who prefer a lightweight, centralized record over automated multi-platform sync.",
  },
  {
    q: "Is there a free plan?",
    a: "Yes. The free plan includes 3 properties, 20 reservations per month, and the full analytics dashboard — no credit card required.",
  },
  {
    q: "Can I upgrade later?",
    a: "Yes. Start on the free plan and upgrade to Pro (10 properties, 3 team users, unlimited reservations) or Enterprise (unlimited everything) whenever your portfolio grows.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Six criteria independent hosts should evaluate — and how Smapey stacks up against each one. Start free and decide for yourself.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=AIRBNB&plan=FREE`}
            ...
            Try Smapey free — no card needed <ChevronRight className="w-4 h-4" />
          </a>
          <a href="/airbnb" className="flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 hover:bg-white/10 text-white/70 hover:text-white font-medium text-sm transition-all border border-white/10">
            View all features
          </a>
        </div>
    ...
    <section className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          <p className="text-sky-600 text-sm font-semibold uppercase tracking-widest mb-3">Evaluation criteria</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Six features every host should look for
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Most hosts switch tools because they hit the same wall — usually a double booking, a missed payment, or zero visibility into which channel drives revenue.
          </p>
        </Animate>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {CRITERIA.map(({ icon: Icon, title, desc, color, shadow }, i) => (
  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-6">
        <Animate className="text-center mb-16">
          <p className="text-sky-600 text-sm font-semibold uppercase tracking-widest mb-3">Smapey plans</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">What's included in each plan</h2>
          <p className="text-slate-500 mt-4">Start free. All six criteria above are covered on every plan.</p>
        </Animate>
        <Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Try the best Airbnb management software for free
        </h2>
        <p className="text-white/40 mb-8">Free forever. No credit card. Start with 3 properties and see if it fits.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=AIRBNB&plan=FREE`}
...
export default function BestAirbnbManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="airbnb" currentPath="/airbnb/best-airbnb-management-software" />
      <Footer />
    </main>
  )
}
