  ...
  return (
    <HeroShell>
      <div className="max-w-3xl">
        <HeroBadge>Built for Philippine car shops</HeroBadge>
        <h1 className="text-4xl sm:text-6xl font-extrabold leading-[1.05] tracking-tight mb-6" style={{ color: INK }}>
          Auto repair shop software that remembers every car
        </h1>
        <p className="text-lg leading-relaxed mb-8" style={{ color: "#54514c" }}>
          Job orders with parts and labour, service history by plate number, parts inventory with
          real margin, and quotes your customer approves from their phone. Free to start, no card.
        </p>
