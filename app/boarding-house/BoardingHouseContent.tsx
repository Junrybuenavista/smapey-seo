...
export default function BoardingHouseContent() {
  return (
    <main>
      ...
      <CTA />
      {/* This page is the money page now, so it links only to the three hubs.
          InternalLinks carded out to the whole cluster, including pages deeper
          in the silo - the leak Rule 1 exists to prevent. */}
      <ApexHubLinks />
      <Footer />
    </main>
  )
