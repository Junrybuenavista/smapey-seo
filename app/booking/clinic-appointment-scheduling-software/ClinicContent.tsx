...
const FEATURES = [
  {
    ...
    desc: "Create, confirm, cancel, and complete patient appointments in one organized dashboard. No more paper logbooks or scattered spreadsheets.",
    color: "from-teal-600 to-teal-400",
    shadow: "shadow-teal-500/20",
  },
  {
    icon: Stethoscope,
    title: "Doctor & Staff Assignment",
    desc: "Assign each appointment to the right doctor, nurse, or specialist. Patients always know who they're seeing — and your team stays coordinated.",
    color: "from-cyan-600 to-teal-400",
    shadow: "shadow-cyan-500/20",
  },
  {
    icon: Clock,
    title: "Clinic Availability Scheduling",
    desc: "Set open hours per day and assign staff to specific time blocks. Control exactly when patients can be booked in.",
    color: "from-teal-500 to-emerald-400",
    shadow: "shadow-teal-400/20",
  },
  {
    icon: CreditCard,
    title: "Deposit & Fee Tracking",
    desc: "Record consultation fees and deposits. Mark payments as paid or unpaid and keep your revenue visible without a separate tool.",
  ...
  },
  {
    ...
    desc: "Define your clinic's services — consultations, check-ups, procedures — with custom durations and prices. Activate or deactivate anytime.",
  ...
  },
  {
    ...
    desc: "See today's patient schedule, monthly appointment totals, completion rates, and upcoming bookings at a glance.",
  ...
  },
  {
    ...
    desc: "Invite receptionists, nurses, and clinic managers with role-based access. Control who can create, edit, or view appointments.",
  ...
  },
  {
    ...
    desc: "Your patient list and appointment records are fully isolated. No data is ever shared across clinics or businesses.",
...
const FAQS = [
  {
    q: "Is this built for medical clinics specifically?",
    a: "Yes — the workflow maps directly to how clinics operate. Assign doctors, track consultation fees, manage patient appointment slots, and move bookings through a Pending → Confirmed → Completed flow.",
  },
  {
    q: "Can we assign appointments to specific doctors?",
    a: "Yes. Each appointment has a staff assignment field. You can assign Dr. Santos to one booking and Dr. Reyes to another — all tracked separately.",
  },
  {
    q: "How does deposit/fee tracking work?",
    a: "When creating an appointment you can record a fee or deposit amount and mark it as paid or unpaid. It's a simple record-keeping field — no payment processing at the appointment level.",
  },
  {
    q: "Can our receptionist use this without full admin access?",
    a: "Yes. You can invite staff with limited access so they can create and manage appointments without seeing billing or admin settings.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-teal-500/10 border border-teal-500/20 text-teal-400 text-xs font-semibold mb-6">
          ...
          Built for clinics & medical practices
        </div>
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Smapey Booking helps clinics manage patient appointments, assign doctors, track deposits,
          and run a full schedule — without the chaos of paper logs or manual spreadsheets.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Everything your clinic's front desk needs
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From patient booking to doctor assignment to payment tracking — all in one place.
          </p>
        </Animate>
  ...
  return (
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">Ready to modernize your clinic?</h2>
        <p className="text-white/40 mb-8">Join clinics and practices that trust Smapey Booking to run their schedules.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=BOOKING&plan=FREE`}
...
export default function ClinicContent() {
  return (
    <main>
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="booking" currentPath="/booking/clinic-appointment-scheduling-software" />
      <Footer />
    </main>
  )
}
