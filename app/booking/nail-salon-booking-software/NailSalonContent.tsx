...
const FEATURES = [
  {
    icon: CalendarDays,
    title: "Nail Appointment Management",
    desc: "Book, confirm, and complete nail appointments in one clean dashboard. See your full day at a glance — no paper booking books.",
    color: "from-teal-600 to-teal-400",
    shadow: "shadow-teal-500/20",
  },
  {
    icon: Sparkles,
    title: "Nail Tech Assignment",
    desc: "Assign each appointment to the right nail technician. Clients know who they're seeing, and every tech's schedule stays balanced.",
  ...
  },
  {
    ...
    desc: "Set working hours per nail tech per day. Prevent overbooking automatically and control exactly when clients can be scheduled.",
  ...
  },
  {
    ...
    desc: "Collect deposits to reduce no-shows. Record amounts and mark them paid or unpaid — all tracked without a separate spreadsheet.",
  ...
  },
  {
    ...
    desc: "List your nail services — manicure, pedicure, gel, acrylics — with custom durations and prices. Activate or deactivate anytime.",
  ...
  },
  {
    ...
    desc: "See today's nail appointments, monthly totals, and completion rates at a glance. Know your busiest days and plan accordingly.",
  ...
  },
  {
    ...
    desc: "Invite your nail techs and front desk staff with role-based access. Control who can book, edit, or view appointments.",
  ...
  },
  {
    ...
    desc: "Your client list and appointment records are fully isolated. No data is ever shared with other nail salons or businesses.",
...
const PLANS = [
  {
    ...
    planKey: "FREE",
    product: "BOOKING",
    desc: "Perfect for solo nail techs just starting out.",
  ...
  },
  {
    ...
    planKey: "PRO",
    product: "BOOKING",
    desc: "For nail salons with multiple techs.",
  ...
  },
  {
    ...
    planKey: "ENTERPRISE",
    product: "BOOKING",
    desc: "For multi-location nail salons.",
...
const FAQS = [
  {
    q: "Can I manage multiple nail techs on one account?",
    a: "Yes. Invite your nail techs as team members and assign each appointment to the right person. Everyone sees their own schedule.",
  },
  {
    q: "How does deposit tracking work?",
    a: "When booking an appointment, you can record a deposit amount and mark it as paid or unpaid. It reduces no-shows and keeps your cash flow visible.",
  },
  {
    q: "Can I list different nail services with different prices?",
    a: "Yes. Each service — manicure, pedicure, gel, acrylics — has its own name, duration, and price.",
  },
  {
    q: "Do clients book online themselves?",
    a: "Currently appointments are created by your staff through the dashboard. It's an internal scheduling tool — ideal for salons where clients call or walk in.",
  },
]
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 via-cyan-400 to-emerald-400">
            that runs your schedule
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Smapey Booking helps nail salons manage appointments, assign nail techs, collect deposits,
          and reduce no-shows — all from one simple dashboard.
        </p>
    ...
    <section id="features" className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">Everything your nail salon needs</h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">From booking to deposit to completion — manage your entire nail salon schedule in one place.</p>
        </Animate>
    ...
    <section id="pricing" className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4">Start free. Scale as your nail salon grows.</p>
          {isPhilippines !== null && (
  ...
  return (
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">Ready to modernize your nail salon?</h2>
        <p className="text-white/40 mb-8">Join nail salons that trust Smapey Booking to run their schedules.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=BOOKING&plan=FREE`}
