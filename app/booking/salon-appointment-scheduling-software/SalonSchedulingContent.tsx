...
const FEATURES = [
  ...
  { icon: BarChart3, title: "Scheduling Dashboard", desc: "See today's full appointment schedule, upcoming bookings, stylist workloads, and monthly totals from one live dashboard." },
  { icon: Users, title: "Team Access Control", desc: "Invite your stylists and front desk team with role-based permissions. Control who can book, edit, or only view the schedule." },
  { icon: Shield, title: "Secure & Isolated", desc: "Your client data and appointment records are fully isolated. Nothing is shared across other salons or businesses." },
]
  ...
  return (
    <section className="py-24 px-6" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <Animate className="relative max-w-3xl mx-auto rounded-[30px] border-2 p-12 md:p-16 text-center" style={{ background: AMBER, borderColor: INK, boxShadow: `10px 10px 0 ${INK}` }}>
        <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-4" style={{ color: INK }}>Ready to take control of your salon schedule?</h2>
        <p className="mb-8 font-medium" style={{ color: "#5c4a28" }}>Join salons that use Smapey Booking to run their appointment scheduling.</p>
