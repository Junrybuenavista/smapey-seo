...
const FEATURES = [
  {
    ...
    desc: "Book, confirm, reschedule, and complete client appointments in one clean dashboard. No double bookings, no missed slots.",
  ...
  },
  {
    ...
    desc: "Assign each appointment to the right stylist or technician. Clients know who they're seeing, and your team stays organized.",
  ...
  },
  {
    ...
    desc: "Set working hours per stylist per day. Control exactly when clients can book and prevent overbooking automatically.",
  ...
  },
  {
    ...
    desc: "Require deposits to reduce no-shows. Record and mark them as paid or unpaid — all tracked without a separate spreadsheet.",
  ...
  },
  {
    ...
    desc: "List all your salon services — haircuts, color, treatments — with custom durations and prices. Activate or deactivate anytime.",
  ...
  },
  {
    ...
    desc: "Move appointments through Pending → Confirmed → Completed with one click. Track no-shows and cancellations over time.",
  ...
  },
  {
    ...
    desc: "See today's bookings, monthly totals, stylist workloads, and completion rates at a glance from your salon dashboard.",
  ...
  },
  {
    ...
    desc: "Invite receptionists and staff with role-based access. Control who can create, edit, or view your booking calendar.",
  ...
  },
  {
    ...
    desc: "Your client list and appointment records are fully isolated. No data is ever shared with other salons or businesses.",
...
const FAQS = [
  {
    q: "Can I manage multiple stylists on one account?",
    a: "Yes. You can invite your stylists as team members and assign each appointment to the right person. Everyone sees only what they need.",
  },
  {
    q: "How does deposit tracking help reduce no-shows?",
    a: "When you require a deposit at booking, clients have skin in the game. You record the deposit amount and mark it as paid — giving you a clear record and reducing last-minute cancellations.",
  },
  {
    q: "Can I list different services with different durations?",
    a: "Yes. Each service has its own name, duration, and price. You can set a haircut to 45 mins and a color treatment to 2 hours — and availability is managed accordingly.",
  },
  {
    q: "Do clients book online themselves?",
    a: "Currently appointments are created by your staff through the dashboard. It's designed as an internal scheduling tool — ideal for salons where clients call or walk in and staff enters the booking.",
  },
]
    ...
    <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#0a1a1a]/90 backdrop-blur-md border-b border-white/5 shadow-lg" : "bg-transparent"}`}>
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="/booking/guide" className="text-sm text-white/60 hover:text-white transition-colors">Guide</a>
        </div>
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Smapey Booking helps salons manage appointments, assign stylists, collect deposits,
          and run a full schedule — all from one simple dashboard.
        </p>
    ...
    <section id="features" className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">Everything your salon needs</h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From booking to deposit to completion — manage your entire salon schedule in one place.
          </p>
        </Animate>
  ...
  return (
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">Ready to fill your booking calendar?</h2>
        <p className="text-white/40 mb-8">Join salons and studios that trust Smapey Booking to run their schedules.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=BOOKING&plan=FREE`}
...
export default function SalonContent() {
  return (
    <main>
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="booking" currentPath="/booking/salon-booking-software" />
      <Footer />
    </main>
  )
}
