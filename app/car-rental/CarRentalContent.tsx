...
const PLANS = [
  {
    ...
    features: ["Up to 5 vehicles", "20 rentals / month", "Customer records", "2 team members"],
  ...
  },
  {
    ...
    features: ["Up to 30 vehicles", "Unlimited rentals", "Overdue tracking", "Revenue dashboard", "5 team members"],
    cta: "Start Pro",
    highlight: true,
  },
  {
    ...
    features: ["Unlimited vehicles", "Unlimited rentals", "Everything in Pro", "Unlimited team members", "Priority support"],
    cta: "Get Enterprise",
    highlight: false,
  },
]
