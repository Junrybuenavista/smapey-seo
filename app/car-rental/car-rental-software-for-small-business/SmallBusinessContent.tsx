    ...
    <section className="py-24" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight" style={{ color: INK }}>Simple enough for a 2-car operation</h2>
          <p className="mt-4 max-w-xl mx-auto" style={{ color: "#54514c" }}>Powerful enough to scale when you're ready to grow.</p>
        </Animate>
