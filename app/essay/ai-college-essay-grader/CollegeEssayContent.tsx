...
import {
  ...
  FileText, MessageSquare, Target, Shield, Award,
} from "lucide-react"
...
const COLLEGE_CRITERIA = [
  {
    icon: Target,
    title: "Hook & Opening Strength",
    desc: "AI evaluates how effectively the essay opens — whether it grabs attention, establishes voice, and draws the reader in from the first line.",
  ...
  },
  {
    ...
    desc: "Scores how clearly the student's story flows — logical structure, smooth transitions, and a coherent narrative arc from start to finish.",
  ...
  },
  {
    ...
    desc: "Flags generic, formulaic writing and rewards authentic personal voice — the quality admissions officers look for most in college essays.",
  ...
  },
  {
    ...
    desc: "Catches sentence-level errors, punctuation issues, and awkward phrasing — so students submit polished, error-free essays.",
    color: "from-violet-600 to-purple-400",
    shadow: "shadow-violet-500/20",
  },
  {
    icon: Award,
    title: "Theme & Self-Reflection",
    desc: "Evaluates whether the essay reveals meaningful insight about the student — the depth of reflection that distinguishes memorable applications.",
    color: "from-indigo-700 to-indigo-500",
    shadow: "shadow-indigo-600/20",
  },
  {
    icon: BarChart3,
    title: "Overall Admissions Readiness",
    desc: "Gives a composite score and summary recommendation — whether the essay is ready to submit or needs another revision pass.",
...
const FAQS = [
  {
    q: "Is this designed specifically for college application essays?",
    a: "Yes. The college essay grader evaluates criteria that matter to admissions officers — authentic voice, narrative clarity, self-reflection depth — not just grammar and structure.",
  },
  {
    q: "Can it handle Common App and other essay prompts?",
    a: "Yes. You can set any prompt when creating the assignment — Common App, Coalition App, school-specific supplemental essays, or custom prompts.",
  },
  {
    q: "How many drafts can a student submit?",
    a: "Unlimited on Pro and Enterprise plans. Students can revise and resubmit as many times as they need, and you can track which draft improved the most.",
  },
  {
    q: "Can students submit directly, or does everything go through the teacher?",
    a: "Both. Teachers share an assignment link with students. Students submit directly, and the teacher sees all submissions in the dashboard.",
  },
  {
    q: "Does it work for international students writing in English?",
    a: "Yes. The AI grades English-language essays regardless of the student's background, and gives feedback that's especially useful for non-native speakers improving their college writing.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden" style={{ background: "#0a0f1e", backgroundImage: "repeating-linear-gradient(45deg, rgba(255,255,255,0.02) 0px, rgba(255,255,255,0.02) 1px, transparent 1px, transparent 28px)", backgroundSize: "28px 28px" }}>
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-semibold mb-6">
          ...
          Admissions-level essay feedback
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          AI college essay grader{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-400 to-violet-400">
            for admissions-level feedback
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Help students write college essays that get noticed. Smapey Essay grades college applications on the criteria admissions officers actually care about — hook, voice, narrative, reflection, and clarity.
        </p>
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-6 text-white/30 text-xs">
          {["No credit card required", "Common App & Coalition support", "Instant feedback on every draft"].map((t) => (
    ...
    <section id="features" className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          <p className="text-indigo-600 text-sm font-semibold uppercase tracking-widest mb-3">Grading Criteria</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">What the AI evaluates in college essays</h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">Six dimensions that mirror what top college admissions officers look for in an application essay.</p>
        </Animate>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {COLLEGE_CRITERIA.map(({ icon: Icon, title, desc, color, shadow }, i) => (
    ...
    <section id="how-it-works" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">From draft to admissions-ready in minutes</h2>
        </Animate>
    ...
    <section id="pricing" className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4">Start free. Scale as your caseload grows.</p>
          {isPhilippines !== null && (
  ...
  return (
    <section className="py-24 relative overflow-hidden" style={{ background: "#0a0f1e", backgroundImage: "repeating-linear-gradient(45deg, rgba(255,255,255,0.02) 0px, rgba(255,255,255,0.02) 1px, transparent 1px, transparent 28px)", backgroundSize: "28px 28px" }}>
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">Help your students get into their dream school</h2>
        <p className="text-white/40 mb-8">Start grading college essays with AI — instant feedback, admissions criteria, and revision tracking.</p>
...
export default function CollegeEssayLandingPage() {
  return (
    <main>
      <Navbar />
      <Hero />
