...
import {
  Package, Users, BarChart3, Shield, CreditCard, MessageSquare,
  CheckCircle2, ChevronRight, Menu, X, Zap, XCircle, Star,
} from "lucide-react"
...
const FREE_FEATURES = [
  {
    icon: Package,
    title: "Up to 50 Orders / Month",
    desc: "Process up to 50 laundry orders per month completely free. Track every order through the full status pipeline — no limits on order size.",
  ...
  },
  {
    ...
    desc: "Find or create customer profiles by phone number. View each customer's order history and total spend — all stored automatically.",
  ...
  },
  {
    ...
    desc: "Record Cash, GCash, Maya, or Bank Transfer per order. Mark orders as paid and track outstanding balances — no spreadsheet needed.",
  ...
  },
  {
    ...
    desc: "See today's orders, pending pickups, and daily revenue from a single live dashboard. Everything you need to start your day.",
  ...
  },
  {
    ...
    desc: "Invite one staff member to help manage your shop. Role-based access ensures each person only sees what they need.",
  ...
  },
  {
    icon: MessageSquare,
    title: "Manual SMS",
    desc: "Send SMS notifications manually when orders are ready. Auto-SMS (triggered at status changes) is available on the Pro plan.",
...
const FAQS = [
  {
    ...
    a: "Yes. The Free plan has no time limit and no credit card is required. You can run your laundry shop on it as long as you like.",
  },
  {
    q: "What happens when I hit 50 orders per month?",
    a: "You'll be prompted to upgrade to the Pro plan to process more orders. Your existing orders and customer data are never deleted.",
  },
  {
    q: "Can I upgrade anytime?",
    a: "Yes. You can upgrade from Free to Pro or Enterprise at any time directly from your dashboard. No data migration required.",
  },
  {
    q: "Is auto-SMS available on the free plan?",
    a: "Auto-SMS (triggered automatically when an order status changes) is a Pro feature. The Free plan includes manual SMS sending. You can upgrade anytime to unlock auto-notifications.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          LaundryOS gives you a full laundry shop management system at zero cost. Process up to 50 orders per month,
          manage customers, track payments, and monitor your shop — all for free, forever.
        </p>
    ...
    <section id="whats-included" className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          <p className="text-sky-600 text-sm font-semibold uppercase tracking-widest mb-3">Free Plan</p>
    ...
    <section id="pricing" className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4">The free plan stays free forever. No pressure.</p>
          {isPhilippines !== null && (
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Start managing your laundry shop for free
        </h2>
        <p className="text-white/40 mb-8">No card, no trial, no catch. Just free laundry management software that works.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=LAUNDRY&plan=FREE`}
...
export default function FreeLaundryAppContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="laundry" currentPath="/laundry/free-laundry-app" />
      <Footer />
    </main>
  )
}
