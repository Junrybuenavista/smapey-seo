...
const FEATURES = [
  { icon: Package, title: "Up to 50 Orders / Month", desc: "Process up to 50 laundry orders per month completely free. Track every order through the full status pipeline - no limits on order size." },
  { icon: Users, title: "Customer Management", desc: "Find or create customer profiles by phone number. View each customer's order history and total spend - all stored automatically." },
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden" style={{ background: CREAM, fontFamily: display.fontFamily }}>
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.04] tracking-tight mb-6" style={{ color: INK }}>
          Free laundry app <span style={{ color: BLUE }}>that actually works</span>
        </h1>
        <p className="text-lg max-w-2xl mx-auto mb-10 leading-relaxed" style={{ color: "#54514c" }}>LaundryOS gives you a full laundry shop management system at zero cost. Process up to 50 orders per month, manage customers, track payments, and monitor your shop, all for free, forever.</p>
  ...
  return (
    <section className="py-24 px-6" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <Animate className="relative max-w-3xl mx-auto rounded-[30px] border-2 p-12 md:p-16 text-center" style={{ background: AMBER, borderColor: INK, boxShadow: `10px 10px 0 ${INK}` }}>
        <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-4" style={{ color: INK }}>Start managing your laundry shop for free</h2>
        <p className="mb-8 font-medium" style={{ color: "#5c4a28" }}>No card, no trial, no catch. Just free laundry management software that works.</p>
