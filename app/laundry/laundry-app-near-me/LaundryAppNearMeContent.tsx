...
import {
  MapPin, MessageSquare, Users, Package, CreditCard, BarChart3,
  CheckCircle2, ChevronRight, Menu, X, Zap, Star,
} from "lucide-react"
...
const LOCAL_FEATURES = [
  {
    ...
    desc: "Build a customer base in your barangay or city. Store every customer's phone number and order history so repeat customers are always recognized.",
    color: "from-sky-600 to-cyan-400",
    shadow: "shadow-sky-500/20",
  },
  {
    icon: MessageSquare,
    title: "SMS Notifications to Nearby Customers",
    desc: "Send automatic SMS alerts when orders are ready — no app download needed. Customers get a text on their phone, wherever they are in your area.",
    color: "from-blue-600 to-sky-400",
    shadow: "shadow-blue-500/20",
  },
  {
    icon: Package,
    title: "Pickup & Delivery Tracking",
    desc: "Track whether an order is a walk-in pickup or a delivery. Add delivery addresses and notes per order so your rider knows exactly where to go.",
    color: "from-cyan-500 to-teal-400",
    shadow: "shadow-cyan-500/20",
  },
  {
    icon: Users,
    title: "Customer Profiles by Phone",
    desc: "Every customer is identified by their phone number. Find returning customers instantly — no account, no login needed from their side.",
  ...
  },
  {
    ...
    desc: "Accept the payment methods your customers actually use: Cash, GCash, Maya, and Bank Transfer. No foreign card required.",
  ...
  },
  {
    ...
    desc: "See how your local shop is performing — today's orders, revenue, and pending pickups — from a single screen you check every morning.",
...
const FAQS = [
  {
    q: "Can I use this app for a laundry shop in any city or barangay in the Philippines?",
    a: "Yes. LaundryOS works for any local laundry shop — whether you're in Metro Manila, Cebu, Davao, or any province. No location restrictions.",
  },
  {
    q: "How do nearby customers get notified when their laundry is ready?",
    a: "Customers receive an SMS on their phone number when you mark their order as ready for pickup. They don't need to install anything.",
  },
  {
    q: "Do I need internet to use the app?",
    a: "Yes, LaundryOS is a cloud-based web app. You'll need an internet connection to accept orders and send SMS notifications. Any smartphone or tablet with internet access works.",
  },
  {
    q: "Can I track multiple orders for customers in the same neighborhood?",
    a: "Yes. Each order has its own ticket number and status. You can have dozens of open orders at once and see all of them in your dashboard.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-sky-500/10 border border-sky-500/20 text-sky-400 text-xs font-semibold mb-6">
          ...
          Built for local laundry shops across the Philippines
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          Your neighborhood laundry shop,{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-cyan-400 to-blue-400">
            powered by smart software
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          LaundryOS helps local laundry shops manage walk-in orders, send SMS pickups to customers,
          and grow their customer base — all without a complicated setup.
        </p>
        ...
        <div className="mt-16 flex flex-wrap items-center justify-center gap-6 text-white/30 text-xs">
          {["No credit card required", "Free plan forever", "Works on any smartphone"].map((t) => (
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Built for local, walk-in laundry shops
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Everything a neighborhood laundry shop needs to manage orders and keep customers coming back.
          </p>
        </Animate>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {LOCAL_FEATURES.map(({ icon: Icon, title, desc, color, shadow }, i) => (
  ...
  return (
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        ...
        <p className="text-white/40 mb-8">Start free. No credit card, no complicated setup. Just a laundry app that works for local shops.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=LAUNDRY&plan=FREE`}
...
export default function LaundryAppNearMeContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="laundry" currentPath="/laundry/laundry-app-near-me" />
      <Footer />
    </main>
  )
}
