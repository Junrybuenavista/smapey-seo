...
import {
  Zap, MessageSquare, Package, CreditCard, BarChart3, Hash,
...
const ON_DEMAND_FEATURES = [
  {
    icon: Package,
    title: "Instant Order Acceptance",
    desc: "Accept a new laundry order in under 30 seconds. Enter the customer's phone, kilos, and service type — ticket number generated automatically.",
    color: "from-sky-600 to-cyan-400",
    shadow: "shadow-sky-500/20",
  },
  {
    icon: MessageSquare,
    title: "Auto-Notify When Ready",
    desc: "The moment you mark an order as 'Ready', the customer gets an SMS. No manual texting, no delays — just instant on-demand communication.",
    color: "from-blue-600 to-sky-400",
    shadow: "shadow-blue-500/20",
  },
  {
    icon: Hash,
    title: "Auto-Ticket on Every Order",
    desc: "Each on-demand order gets a unique ticket number (YYMMDD-NNN). Customers quote this number for quick retrieval — no confusion at pickup.",
    color: "from-cyan-500 to-teal-400",
    shadow: "shadow-cyan-500/20",
  },
  {
    icon: CreditCard,
    title: "GCash & Cash at Pickup",
    desc: "Collect payment when customers arrive — via Cash, GCash, Maya, or Bank Transfer. Mark orders as paid with one tap.",
  ...
  },
  {
    ...
    desc: "See all active on-demand orders in one dashboard — Received, In Progress, Ready, and Released. Know exactly what's waiting at any moment.",
  ...
  },
  {
    ...
    desc: "Offer express processing, stain removal, or fabric conditioner as on-demand add-ons. Price them separately and track them per order.",
...
const FAQS = [
  {
    q: "How fast can I accept a new on-demand order?",
    a: "Under 30 seconds. Enter the customer's phone number (or select a returning customer), choose the service type, enter kilos, and submit. Ticket number is auto-generated instantly.",
  },
  {
    q: "Do customers get notified automatically?",
    a: "Yes. On the Pro plan, customers receive an automatic SMS when you accept their order and another when it's ready for pickup. On the Free plan, SMS can be sent manually.",
  },
  {
    q: "Can I handle multiple on-demand orders at the same time?",
    a: "Yes. All open orders appear in your dashboard. You can update each order's status independently — there's no limit to how many you can have in progress simultaneously (on Pro).",
  },
  {
    q: "What if a customer wants express processing?",
    a: "Add express processing as an add-on service with its own price. It's attached to the specific order and shown in the customer's receipt.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-sky-500/10 border border-sky-500/20 text-sky-400 text-xs font-semibold mb-6">
          ...
          Accept and track on-demand laundry orders instantly
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          Accept laundry orders on demand,{" "}
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          LaundryOS lets your shop accept on-demand orders in seconds, track them through every stage,
          and send automatic SMS notifications — so customers always know when their laundry is ready.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            On-demand order management, built for speed
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Every feature is designed to let you accept, track, and complete on-demand orders as fast as possible.
          </p>
        </Animate>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {ON_DEMAND_FEATURES.map(({ icon: Icon, title, desc, color, shadow }, i) => (
    ...
    <section id="pricing" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4">Start free. Upgrade when you need more orders or auto-SMS.</p>
          {isPhilippines !== null && (
            <div className="inline-flex items-center gap-1.5 mt-4 px-3 py-1 rounded-full bg-slate-100 border border-slate-200 text-xs text-slate-500">
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Ready to accept on-demand laundry orders?
        </h2>
        <p className="text-white/40 mb-8">Start free. No credit card, no complicated setup. Your first order is minutes away.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=LAUNDRY&plan=FREE`}
...
export default function OnDemandContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="laundry" currentPath="/laundry/on-demand-laundry-service-app" />
      <Footer />
    </main>
  )
}
