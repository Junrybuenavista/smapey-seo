    ...
    <section className="py-24" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight" style={{ color: INK }}>On-demand order management, built for speed</h2>
          <p className="mt-4 max-w-xl mx-auto" style={{ color: "#54514c" }}>Every feature is designed to let you accept, track, and complete on-demand orders as fast as possible.</p>
        </Animate>
  ...
  return (
    <section className="py-24 px-6" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <Animate className="relative max-w-3xl mx-auto rounded-[30px] border-2 p-12 md:p-16 text-center" style={{ background: AMBER, borderColor: INK, boxShadow: `10px 10px 0 ${INK}` }}>
        <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-4" style={{ color: INK }}>Ready to accept on-demand laundry orders?</h2>
        <p className="mb-8 font-medium" style={{ color: "#5c4a28" }}>Start free. No credit card, no complicated setup. Your first order is minutes away.</p>
