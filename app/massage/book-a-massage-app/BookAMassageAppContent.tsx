...
const FEATURES = [
  {
    icon: Smartphone,
    title: "Booking in 3 Taps",
    desc: "Clients tap your link, pick a treatment, pick a time, and they're done. No accounts to create, no apps to download — just a clean mobile-first booking experience.",
    color: "from-emerald-600 to-teal-400",
    shadow: "shadow-emerald-500/20",
  },
  {
    icon: Users,
    title: "Pick a Favorite Therapist",
    desc: "Clients can choose their preferred massage therapist when booking — by specialty, name, or just whoever they liked last time. Builds loyalty without you lifting a finger.",
    color: "from-teal-600 to-emerald-400",
    shadow: "shadow-teal-500/20",
  },
  {
    icon: Sparkles,
    title: "See Treatments + Prices Clearly",
    desc: "Your full menu — Swedish, deep tissue, Thai, hot stone — with prices, durations, and photos. Clients know exactly what they're booking, no awkward calls.",
    color: "from-emerald-500 to-cyan-400",
    shadow: "shadow-emerald-500/20",
  },
  {
    icon: Wallet,
    title: "Pay Deposit on the Spot",
    desc: "Show your GCash, Maya, or bank QR code at checkout. Clients send the deposit, paste the reference, and submit — you confirm only verified bookings.",
  ...
  },
  {
    ...
    desc: "Your booking page carries your business name, logo, cover photo, and accent color. Clients see a polished page that feels like an extension of your spa.",
  ...
  },
  {
    ...
    desc: "Instagram bio, Facebook page, WhatsApp, Google Maps — drop your booking link anywhere and clients can book a massage in seconds. No website builder needed.",
...
const FAQS = [
  {
    q: "Do my clients need to download an app to book a massage?",
    a: "No. The booking page is a regular web link — clients tap it in their browser on any phone, tablet, or desktop. There's no app to install, no account to create, and no friction.",
  },
  {
    q: "Can clients book a massage outside business hours?",
    a: "Yes. The booking page is online 24/7. Clients can book at midnight if they want — the inquiry waits in your dashboard until you review and confirm in the morning.",
  },
  {
    q: "What does the client see when they book?",
    a: "They see your branded page with your treatments, prices, durations, and (optionally) your therapists. They pick a service, optionally request a therapist, choose a date and time, fill in name + phone, and submit. That's it.",
  },
  {
    q: "Can I block bookings during my off-hours?",
    a: "The current setup uses a request-and-confirm model — you review every inquiry before it becomes an appointment. That gives you flexibility without strict calendar rules. Most small spas prefer this over rigid availability slots.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs font-semibold mb-6">
          ...
          Let clients book a massage from their phone
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The book-a-massage app{" "}
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          A clean, mobile-first booking page where clients pick a treatment, choose a therapist, and pay a deposit — all in under a minute. Built for spas that respect their clients' time.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Built for the client booking experience
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Most "booking apps" are designed for the business. This one is designed for the person trying to relax.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Give your clients a real booking experience
        </h2>
        <p className="text-white/40 mb-8">Free forever. Five-minute setup. The kind of booking page your clients will share with their friends.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=MASSAGE&plan=FREE`}
