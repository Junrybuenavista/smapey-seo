...
import {
  BookOpen, Users, CalendarPlus, Globe, Inbox, BarChart3, Cloud,
...
const FEATURES = [
  {
    icon: BookOpen,
    title: "Your Massage Book — In the Cloud",
    desc: "Every appointment, every therapist, every client — all in one digital book that runs in your browser. No more flipping pages or rewriting cancellations.",
    color: "from-emerald-600 to-teal-400",
    shadow: "shadow-emerald-500/20",
  },
  {
    icon: CalendarPlus,
    title: "Same-Day Visibility",
    desc: "Open the app, see today's session — every therapist's column, every booked slot, every gap. Plan your day at a glance, just like a real appointment book.",
    color: "from-teal-600 to-emerald-400",
    shadow: "shadow-teal-500/20",
  },
  {
    icon: Users,
    title: "Client Records Built In",
    desc: "Tap any booking to see the client's history, notes, and preferences. No more scribbled cards or searching for last month's notebook.",
    color: "from-emerald-500 to-cyan-400",
    shadow: "shadow-emerald-500/20",
  },
  {
    icon: Globe,
    title: "Online Bookings Land Here",
    desc: "Clients book through your public page, and the appointment appears in your massage book automatically — no manual entry required.",
  ...
  },
  {
    ...
    desc: "Lose your phone, drop your tablet, computer crashes — your massage book lives in the cloud. Sign in from any device and pick up exactly where you left off.",
    color: "from-teal-500 to-cyan-400",
    shadow: "shadow-teal-500/20",
  },
  {
    icon: BarChart3,
    title: "What Paper Books Can't Do",
    desc: "Monthly revenue, completion rate, top services, pending inquiries — your dashboard updates in real time. Try doing that with a Moleskine.",
...
const COMPARISON = [
  ...
  { feature: "Treatments", free: "10", pro: "50", enterprise: "Unlimited" },
  { feature: "Online booking page", free: true, pro: true, enterprise: true },
  { feature: "Client records & notes", free: true, pro: true, enterprise: true },
  { feature: "Cloud backup", free: true, pro: true, enterprise: true },
  { feature: "Priority support", free: false, pro: false, enterprise: true },
]

const FAQS = [
  {
    q: "Is this really a digital replacement for a paper massage book?",
    a: "Yes. Every appointment your team takes lives in one shared, searchable book — with the client's name, treatment, therapist, time, and notes. Unlike paper, it's visible to everyone with access and backed up automatically.",
  },
  {
    q: "How long does it take to switch from a paper book?",
    a: "Most small spas finish their setup in under 10 minutes — add your treatments, your therapists, and a couple of clients. You can keep using paper alongside the app for a week if you'd like to ease in.",
  },
  {
    q: "What if my internet goes down at the front desk?",
    a: "Once a page is loaded, you can keep viewing it. The app syncs as soon as you reconnect. For most small spas the bigger risk is losing a paper book — and that's the problem this app solves.",
  },
  {
    q: "Can multiple staff see the same massage book?",
    a: "Yes. Add team members to your account and everyone sees the same up-to-the-minute book. Permissions decide who can edit, view, or add bookings — no more arguments over who wrote what.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs font-semibold mb-6">
          ...
          Digital appointment book for spas
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The massage book app{" "}
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Replace your paper massage book with a digital version your whole team shares. Every booking, every therapist, every client — backed up, searchable, and visible from anywhere.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            A massage book that actually works for you
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Everything a paper book gives you — plus search, sync, and zero lost data.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Trade your paper book for the cloud
        </h2>
        <p className="text-white/40 mb-8">Free forever. No card. The digital massage book your team will actually use.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=MASSAGE&plan=FREE`}
...
export default function MassageBookAppContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="massage" currentPath="/massage/massage-book-app" />
      <Footer />
    </main>
  )
}
