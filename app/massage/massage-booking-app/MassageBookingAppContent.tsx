...
import {
  CalendarPlus, Users, Globe, Inbox, BarChart3, Wallet, Sparkles,
...
const FEATURES = [
  {
    ...
    desc: "Your massage business gets a branded booking page out of the box. Clients pick a treatment, a therapist, a time — and the booking lands in your dashboard automatically.",
  ...
  },
  {
    ...
    desc: "Assign every booking to the right therapist — Swedish, deep tissue, Thai, prenatal — based on their specialties. Clients can request a preferred therapist on the booking page.",
    color: "from-teal-600 to-emerald-400",
    shadow: "shadow-teal-500/20",
  },
  {
    icon: Sparkles,
    title: "Treatments with Real Durations",
    desc: "Define each treatment with its true session length, price, and image. No more 60-minute slots that should have been 90 — the booking page shows clients exactly what to expect.",
  ...
  },
  {
    ...
    desc: "Reduce no-shows. Upload your GCash or bank QR code, set a deposit amount, and require a reference number on the booking form. Premium treatments are protected.",
  ...
  },
  {
    ...
    desc: "Every booking request — name, phone, preferred date, deposit reference — lands in one tab. Accept, decline, or convert it to a confirmed appointment in a single click.",
  ...
  },
  {
    ...
    desc: "Live dashboard shows monthly revenue, today's sessions, completion rate, and pending inquiries. Know exactly how your booking app is performing — no spreadsheets needed.",
...
const COMPARISON = [
  ...
  { feature: "Revenue dashboard", free: true, pro: true, enterprise: true },
  { feature: "Priority support", free: false, pro: false, enterprise: true },
]

const FAQS = [
  {
    q: "How is this different from other massage booking apps?",
    a: "Most booking apps are designed for hair salons or general appointments. Smapey is built around what spas actually need — therapist specialties, treatment durations, client intake notes, and deposit collection — without enterprise complexity or pricing.",
  },
  {
    q: "Can clients book a specific therapist online?",
    a: "Yes. Your booking page lets clients optionally pick their preferred therapist before submitting the inquiry. The choice flows into your inbox so you can honor it on confirmation.",
  },
  {
    q: "Do I need to install anything?",
    a: "No. Smapey runs entirely in the cloud. You sign in from any browser on any device, and your data is always in sync. No app store download, no installs, no IT setup.",
  },
  {
    q: "Is there really a free plan?",
    a: "Yes — no expiration, no card required. The free plan supports up to 50 appointments per month, 10 treatments, and 2 therapists. Perfect for a solo therapist or a small studio.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs font-semibold mb-6">
          ...
          Online booking for massage businesses
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The massage booking app{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 via-teal-300 to-cyan-300">
            built for spas and therapists
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Let clients book massages on your branded page — pick a therapist, pick a treatment, pay a deposit. Every booking lands in your inbox, ready to confirm in one click.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Everything a massage booking app should do
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From the first inquiry to the final session — built around how a real spa runs.
          </p>
        </Animate>
  ...
  return (
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        ...
        <p className="text-white/40 mb-8">Free forever. No card. Set up your booking page in under five minutes.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=MASSAGE&plan=FREE`}
...
export default function MassageBookingAppContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="massage" currentPath="/massage/massage-booking-app" />
      <Footer />
    </main>
  )
}
