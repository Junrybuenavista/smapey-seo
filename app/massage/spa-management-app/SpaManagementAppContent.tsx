...
import {
  Flower2, Users, CalendarPlus, Globe, Wallet, BarChart3, Sparkles,
...
const FEATURES = [
  {
    icon: Flower2,
    title: "Treatments + Packages",
    desc: "Manage facials, massages, body scrubs, and multi-step packages from a single catalog. Each treatment carries its own duration, price, and image — clients see exactly what they're getting.",
  ...
  },
  {
    ...
    desc: "Add every therapist with their name, specialties, and contact details. Assign appointments by skill — Swedish, deep tissue, prenatal, hot stone — so clients get the right pro every time.",
  ...
  },
  {
    ...
    desc: "Each client profile stores intake info — allergies, pressure preferences, medical history, areas to avoid. Your therapists are briefed before the session starts.",
  ...
  },
  {
    ...
    desc: "Protect your high-value sessions. Toggle deposits on, upload your GCash or bank QR code, and clients pay before confirmation. No-shows go down, revenue stays predictable.",
  ...
  },
  {
    ...
    desc: "Get a unique URL with your spa's logo, cover photo, accent color, and tagline. Share it on Instagram, Facebook, Google Maps — anywhere clients find you online.",
  ...
  },
  {
    icon: BarChart3,
    title: "Spa Analytics",
    desc: "Monthly revenue, top treatments, completion rate, pending inquiries, and per-therapist performance — all from one live dashboard. Make decisions based on data, not gut feel.",
...
const FAQS = [
  {
    q: "Is Smapey a full spa management app, or just bookings?",
    a: "Both. The spa management app covers treatments, therapists, clients, appointments, deposits, inquiries, and analytics. You can run your entire spa from this one dashboard — bookings are just one piece.",
  },
  {
    q: "Can I track per-therapist performance?",
    a: "Yes. The Pro and Enterprise plans show per-therapist appointment counts and revenue contribution, so you can see who's busiest, plan commissions fairly, and balance the workload.",
  },
  {
    q: "Does it handle multi-step spa packages?",
    a: "Each treatment is defined with a true session length, so a 90-minute package shows correctly on the booking page and your schedule. You can also create longer combo treatments as individual services with custom durations and pricing.",
  },
  {
    q: "Can I run multiple spa locations from one account?",
    a: "Each Smapey account represents one spa organization. The Enterprise plan supports unlimited team members, services, and appointments — suitable for a large single-location spa or for centralized booking. For separate locations with separate revenue books, run a separate account per branch.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs font-semibold mb-6">
          ...
          All-in-one spa & wellness platform
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The spa management app{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 via-teal-300 to-cyan-300">
            small spas actually use
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Treatments, therapists, client intake, deposits, and analytics — all in one clean dashboard. Built for wellness businesses that need clarity, not enterprise complexity.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Run your spa from one elegant dashboard
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From treatments to therapists to analytics — every essential a small spa needs, none of the bloat.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Run your spa beautifully
        </h2>
        <p className="text-white/40 mb-8">Free forever. No card. The spa management app that respects how you actually work.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=MASSAGE&plan=FREE`}
...
export default function SpaManagementAppContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="massage" currentPath="/massage/spa-management-app" />
      <Footer />
    </main>
  )
}
