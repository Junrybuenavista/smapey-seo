...
const FEATURES = [
  {
    icon: Sparkles,
    title: "Beauty Service Catalogue",
    desc: "List all your beauty services — hair coloring, keratin treatment, blowout, facial, makeup, lashes, and more. Each service shows price and duration on your booking page.",
  ...
  },
  {
    ...
    desc: "Store client notes alongside their appointment history — preferred hair color formulas, skin sensitivities, makeup preferences, and allergy information.",
  ...
  },
  {
    ...
    desc: "Assign appointments to specific stylists, colorists, or beauty specialists. Clients can request their preferred staff when they submit a booking inquiry.",
  ...
  },
  {
    ...
    desc: "Your beauty salon gets a unique URL. Share it on Instagram, Facebook, or WhatsApp — clients browse your services and send booking requests directly.",
  ...
  },
  {
    ...
    desc: "All incoming booking requests appear in your Inquiries tab. Review and confirm bookings in seconds, and convert them into scheduled appointments.",
  ...
  },
  {
    ...
    desc: "Track total revenue, most-booked services, appointment volume, and pending inquiries from your dashboard. Understand which services drive the most income.",
...
const FAQS = [
  {
    q: "Can I store client hair color formulas in the app?",
    a: "Yes. Each client profile has a notes field where you can record specific information — including hair color formulas, skin type, allergies, and any preferences your staff should know before the appointment.",
  },
  {
    q: "How does the booking page work for beauty salons?",
    a: "Your beauty salon gets a unique URL. Clients visit the page, see your full service menu with prices, and submit a booking inquiry. You review and confirm it from your dashboard — no phone tag required.",
  },
  {
    q: "Is the app suitable for a home-based beauty studio?",
    a: "Yes. The free plan is perfect for solo beauticians working from home. Add your services, share your booking link, and manage all your appointments from your phone.",
  },
  {
    q: "Can I list different services for hair, skin, and nails?",
    a: "Yes. You can add as many service categories as you offer. The free plan supports up to 5 services, and the Pro plan supports up to 20 — enough for most full-service beauty salons.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The beauty salon management app{" "}
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Manage hair, skin, makeup, and nail appointments from one dashboard. Store client preferences, publish a booking page, and track your beauty business revenue — all for free.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Built for beauty — hair, skin, nails, and more
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Everything a beauty salon needs to manage clients, bookings, and revenue in one place.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Start managing your beauty salon for free
        </h2>
        <p className="text-white/40 mb-8">No card, no trial. A beauty salon management app that works from day one.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function BeautySalonManagementAppContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/beauty-salon-management-app" />
      <Footer />
    </main>
  )
}
