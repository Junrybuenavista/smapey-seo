...
import {
  Sparkles, Users, Scissors, Globe, Inbox, BarChart3, Heart,
...
const FEATURES = [
  {
    ...
    desc: "List every beauty service you offer — hair coloring, keratin treatments, blowouts, facials, lashes, brows, makeup. Each one carries its own price, duration, and photo.",
    color: "from-pink-600 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Heart,
    title: "Client History & Preferences",
    desc: "Store client notes alongside their visit history — preferred hair color formulas, skin sensitivities, makeup style, allergies. Your stylists always know what to expect.",
    color: "from-rose-600 to-pink-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: Scissors,
    title: "Stylist & Specialist Assignment",
    desc: "Assign appointments to specific stylists, colorists, or beauticians. Clients can request their favorite specialist on the booking page — and your team picks up where they left off.",
    color: "from-fuchsia-600 to-pink-400",
    shadow: "shadow-fuchsia-500/20",
  },
  {
    icon: Globe,
    title: "Public Beauty Booking Page",
    desc: "Your beauty salon gets a branded URL. Share it on Instagram, Facebook, or WhatsApp — clients browse your services and submit bookings directly.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Inbox,
    title: "Inquiry & Deposit Pipeline",
    desc: "Booking inquiries arrive in one inbox. Optionally require a deposit before confirming high-value services like color or keratin — with a QR code on your page.",
    color: "from-rose-500 to-fuchsia-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: BarChart3,
    title: "Beauty Business Analytics",
    desc: "Track which services drive the most revenue, how many bookings you complete per month, and where pending inquiries are coming from. Understand your business at a glance.",
...
const COMPARISON = [
  ...
  { feature: "Beauty services", free: "10", pro: "50", enterprise: "Unlimited" },
...
const FAQS = [
  {
    q: "Is Smapey designed specifically for beauty salons?",
    a: "Smapey is purpose-built for service-based salons — beauty salons fit perfectly. Hair, skin, makeup, brow, and lash businesses all use Smapey to manage bookings, clients, services, and a public page from one dashboard.",
  },
  {
    q: "Can I store client hair color formulas or skincare notes?",
    a: "Yes. Every client profile includes a notes field where you can record formulas, skin sensitivities, color history, allergies, or anything else your stylist needs to know before the appointment.",
  },
  {
    q: "How does the booking page work for a beauty salon?",
    a: "Your beauty salon gets a unique URL. Clients visit the page, see your full menu with prices and photos, and submit a booking inquiry. You review and confirm it from your dashboard — no phone tag required.",
  },
  {
    q: "Is the app suitable for a home-based beauty studio?",
    a: "Absolutely. The free plan is perfect for solo beauticians and home-based studios — add your services, share your booking link on Instagram, and manage every appointment from your phone.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs font-semibold mb-6">
          ...
          Built for beauty salons and studios
        </div>
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Manage hair, skin, makeup, brow, and lash services from one elegant platform. Built for stylists, colorists, and beauticians who want clarity, not complexity.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            The beauty salon stack, refined
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Hair, skin, makeup, lashes, brows — every beauty service handled cleanly in one app.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Manage your beauty business beautifully
        </h2>
        <p className="text-white/40 mb-8">Free for life. No card needed. Setup takes less than five minutes.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function BeautySalonManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/beauty-salon-management-software" />
      <Footer />
    </main>
  )
}
