...
import {
  Star, Users, Scissors, Globe, Inbox, BarChart3, Trophy, Calendar,
...
const FEATURES = [
  {
    icon: Trophy,
    title: "Best Value for Small Salons",
    desc: "A free plan that actually works for a real salon — 50 appointments, 10 services, 2 team members. Paid tiers stay competitive while bigger tools start at 5× the price.",
    color: "from-pink-600 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Calendar,
    title: "Best for Daily Booking Flow",
    desc: "Add an appointment, assign a stylist, and confirm — three clicks. No multi-screen setup, no confusing fields. Everything optimized for the speed a busy salon needs.",
    color: "from-rose-600 to-pink-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: Globe,
    title: "Best Public Booking Page",
    desc: "Branded URL, theme customization, your own cover photo, deposit QR codes — all included on the free plan. Most competitors lock these behind paid tiers.",
    color: "from-fuchsia-600 to-pink-400",
    shadow: "shadow-fuchsia-500/20",
  },
  {
    icon: Users,
    title: "Best for Teams Under 5",
    desc: "Role-based access, per-staff appointment assignment, and a public-page request system — at a price that makes sense for a small team, not a national chain.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Inbox,
    title: "Best Inquiry Pipeline",
    desc: "Booking inquiries flow into one inbox with deposit references and client notes. Approve, decline, or convert to appointment in one click — no third-party tools.",
    color: "from-rose-500 to-fuchsia-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: BarChart3,
    title: "Best Real-Time Dashboard",
    desc: "Live monthly revenue, appointment volume, completion rate, top services. The metrics that actually drive salon decisions — not a 40-page report you'll never read.",
...
const COMPARISON = [
  ...
  { feature: "Services in catalog", free: "10", pro: "50", enterprise: "Unlimited" },
  { feature: "Team members", free: "2", pro: "5", enterprise: "Unlimited" },
  { feature: "Public booking page", free: true, pro: true, enterprise: true },
  { feature: "Custom themes", free: true, pro: true, enterprise: true },
...
const FAQS = [
  {
    q: "What makes Smapey the best salon management software for small salons?",
    a: "Smapey was designed specifically for solo stylists and small salons — not as a stripped-down version of enterprise software. The free plan is genuinely usable for a working salon, paid plans stay affordable, and the interface is fast enough to use during a busy day.",
  },
  {
    q: "How does Smapey compare to bigger salon software platforms?",
    a: "Bigger platforms add features like inventory tracking with SKU codes, loyalty programs, and POS integrations — useful for chains, but heavy and expensive for solo stylists. Smapey covers the essentials small salons actually need without the bloat or cost.",
  },
  {
    q: "Is there really a free plan, or just a free trial?",
    a: "There's a real free plan — no expiration, no card required. It supports up to 50 appointments per month, 10 services, and 2 team members, plus the full public booking page. You only upgrade when your salon outgrows those limits.",
  },
  {
    q: "Can I switch from another salon management app?",
    a: "Yes. There's no contract or lock-in. Sign up free, add your services and clients, and run Smapey alongside your current tool until you're confident. Many small salons fully switch within a week.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Why thousands of solo stylists and small salon owners pick Smapey over the bloated, expensive alternatives. Honest comparison inside — no marketing fluff.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
            ...
            Try the best free — no card <ChevronRight className="w-4 h-4" />
          </a>
...
function SalonFeatures() {
  return (
    <section className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          <p className="text-pink-600 text-sm font-semibold uppercase tracking-widest mb-3">Why Smapey</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Six reasons we're picked as the best
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            The features that matter most to small salons — done well, priced fairly, no bloat.
          </p>
        </Animate>
                  ...
                  <tr key={row.feature} className={`border-b border-slate-100 ${i % 2 === 0 ? "bg-white" : "bg-slate-50/50"}`}>
                    ...
                    {[row.free, row.pro, row.enterprise].map((val, j) => (
                      <td key={j} className={`text-center px-6 py-4 ${j === 1 ? "bg-pink-50/50" : ""}`}>
                        {typeof val === "boolean" ? (
                          val
                            ? <CheckCircle2 className="w-5 h-5 text-pink-500 mx-auto" />
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          See why small salons call it the best
        </h2>
        <p className="text-white/40 mb-8">Free forever, no card, no commitment. Try it for a week and decide for yourself.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function BestSalonManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/best-salon-management-software" />
      <Footer />
    </main>
  )
}
