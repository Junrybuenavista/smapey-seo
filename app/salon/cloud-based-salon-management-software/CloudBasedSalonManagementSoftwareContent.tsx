...
import {
  Cloud, Smartphone, Scissors, Globe, Inbox, BarChart3, Shield, Wifi,
...
const FEATURES = [
  {
    ...
    desc: "Smapey runs entirely in the cloud — no installs, no servers, no IT setup. Sign in from any browser and your salon dashboard loads instantly.",
  ...
  },
  {
    ...
    desc: "The same interface works on every device. Manage today's appointments from your phone at the front desk, then close the books from your laptop at home.",
  ...
  },
  {
    ...
    desc: "Add an appointment on your tablet — it appears on your assistant's phone in real time. No exports, no manual sync, no lost data when you change devices.",
  ...
  },
  {
    ...
    desc: "Every client, appointment, and service is backed up automatically. Hard drive crash? Phone stolen? Your data is safe in the cloud — sign in from any new device and continue.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Globe,
    title: "Public Page on Demand",
    desc: "Your salon's public booking page is hosted by Smapey — no domain to buy, no website to build. Share the link anywhere and clients can book immediately.",
  ...
  },
  {
    ...
    desc: "Cloud means live data. Your revenue dashboard updates the moment an appointment is completed — no end-of-day reconciliation, no waiting for reports.",
...
const COMPARISON = [
  { feature: "Cloud-hosted (no install)", free: true, pro: true, enterprise: true },
  { feature: "Multi-device sync", free: true, pro: true, enterprise: true },
  { feature: "Automatic backups", free: true, pro: true, enterprise: true },
...
const FAQS = [
  {
    q: "What does 'cloud-based' mean for my salon?",
    a: "Cloud-based means Smapey runs on Smapey's servers, not your computer. You access your salon dashboard through a web browser — Chrome, Safari, Edge, whatever you prefer. No installs, no updates to manage, no IT person needed.",
  },
  {
    q: "Do I need fast internet to use it?",
    a: "Smapey works on any normal internet connection. Pages are small and load quickly even on mobile data. If the connection drops mid-action, your work resumes the moment you reconnect — nothing is lost.",
  },
  {
    q: "Is my salon's data safe in the cloud?",
    a: "Yes. Your data is backed up automatically, encrypted at rest, and accessible only from your own login. We use industry-standard hosting and security practices, so your client list and appointment history are safer than they'd be on a local computer.",
  },
  {
    q: "What happens if I lose my phone or laptop?",
    a: "Nothing. Your data lives in the cloud, not on your device. Sign in from any other phone, tablet, or computer and your dashboard is exactly as you left it. This is one of the biggest advantages of cloud-based salon software.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Manage your salon from your phone, tablet, or any computer. No installs, no servers, no manual backups — just open a browser and your business is right there.
        </p>
    ...
    <section className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          <p className="text-pink-600 text-sm font-semibold uppercase tracking-widest mb-3">Why Cloud</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            The benefits of cloud-based salon software
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Modern salons don't run on installed software. Here's why cloud changes the game.
          </p>
        </Animate>
  ...
  return (
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        ...
        <p className="text-white/40 mb-8">Free for life. Cloud-native. Open a browser and you're in business.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function CloudBasedSalonManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/cloud-based-salon-management-software" />
      <Footer />
    </main>
  )
}
