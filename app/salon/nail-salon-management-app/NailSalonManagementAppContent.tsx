...
import {
  Palette, Users, Scissors, Globe, Inbox, BarChart3,
...
const FEATURES = [
  {
    ...
    desc: "Add all your nail services — gel manicure, acrylic full set, nail art, pedicure, dip powder, and more. Each service shows up on your public booking page with price and duration.",
    color: "from-pink-600 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Users,
    title: "Client Nail Preferences",
    desc: "Record each client's preferred nail shape, favorite colors, gel vs. acrylic preference, and any sensitivities. Your nail techs always know what the client wants.",
    color: "from-rose-600 to-pink-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: Scissors,
    title: "Nail Technician Assignment",
    desc: "Assign appointments to specific nail technicians. Clients can request their preferred tech when submitting a booking inquiry through your booking page.",
    color: "from-fuchsia-600 to-pink-400",
    shadow: "shadow-fuchsia-500/20",
  },
  {
    icon: Globe,
    title: "Nail Salon Booking Page",
    desc: "Get a unique booking URL for your nail salon. Share it on social media or in your bio — clients browse your services and send a booking inquiry online.",
  ...
  },
  {
    ...
    desc: "Incoming nail appointment requests appear in your Inquiries tab. Accept or decline with one click and convert confirmed inquiries into scheduled appointments.",
  ...
  },
  {
    ...
    desc: "Monitor monthly revenue, appointment volume, and service popularity from your dashboard. Know which nail services are your best performers.",
...
const FAQS = [
  {
    q: "Can I track each client's nail preferences?",
    a: "Yes. Each client profile includes a notes section where you can record preferred nail shape, favorite gel colors, acrylic vs. gel preference, and any sensitivities or allergies.",
  },
  {
    q: "How does online booking work for nail salons?",
    a: "Your nail salon gets a unique booking page URL. Clients browse your service menu and submit a booking inquiry with their preferred date, time, and service. You confirm it from your dashboard.",
  },
  {
    q: "Can I manage multiple nail technicians?",
    a: "Yes. Add your nail techs as team members and assign appointments to specific individuals. The Pro plan supports up to 5 team members.",
  },
  {
    q: "Does the app work for home-based nail technicians?",
    a: "Absolutely. The free plan is ideal for solo nail technicians. Add your services, share your booking link, and manage all appointments from your phone.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs font-semibold mb-6">
          ...
          Built for nail salons and nail technicians
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The nail salon management app{" "}
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Book nail appointments, track client preferences (gel, acrylic, nail art), publish a booking page, and manage your nail salon revenue — all from one dashboard. Free to start.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From gel manicures to acrylic sets — manage every nail appointment and client record in one app.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Start managing your nail salon for free
        </h2>
        <p className="text-white/40 mb-8">No card, no trial. A nail salon app that keeps your schedule and client records organized.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function NailSalonManagementAppContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/nail-salon-management-app" />
      <Footer />
    </main>
  )
}
