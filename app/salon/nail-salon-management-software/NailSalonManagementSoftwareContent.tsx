...
import {
  Paintbrush, Users, Calendar, Globe, Inbox, BarChart3, Scissors,
...
const FEATURES = [
  {
    ...
    desc: "Manicure, pedicure, gel, acrylics, dip powder, nail art — list every service with its own price, duration, and photo. Your menu drives both the studio booking screen and your public page.",
  ...
  },
  {
    ...
    desc: "Assign each booking to the right nail tech. Track who's free, who's busy, and which technician each client prefers — no awkward overlap, no missed bookings.",
    color: "from-rose-600 to-pink-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: Calendar,
    title: "Multi-Hour Service Support",
    desc: "Long acrylic sets and detailed nail art often run 90+ minutes. Smapey tracks every service's true duration so your day isn't full of double-booked back-to-back slots.",
  ...
  },
  {
    ...
    desc: "Your nail salon gets a branded URL. Clients see your menu, request a tech, pick a date — and the inquiry lands in your dashboard. Perfect for Instagram bio links.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Inbox,
    title: "Client Notes & Preferences",
    desc: "Store nail length preferences, favorite colors, allergies, and last service notes. Repeat clients feel remembered — and your techs are set up to deliver every time.",
  ...
  },
  {
    ...
    desc: "See which nail services drive the most revenue — gel manis, full sets, nail art? Use the data to plan promos, restock supplies, or expand your menu.",
...
const COMPARISON = [
  ...
  { feature: "Nail services in menu", free: "10", pro: "50", enterprise: "Unlimited" },
  { feature: "Technicians", free: "2", pro: "5", enterprise: "Unlimited" },
  { feature: "Public booking page", free: true, pro: true, enterprise: true },
  { feature: "Client preferences & notes", free: true, pro: true, enterprise: true },
...
const FAQS = [
  {
    q: "Is Smapey built for nail salons specifically?",
    a: "Smapey is built for service-based salons, and nail salons fit the model perfectly — define your nail services, assign technicians, accept booking inquiries, and run your day from one dashboard. Many nail salons use Smapey as their full management system.",
  },
  {
    q: "Can clients request their favorite nail tech?",
    a: "Yes. Your public booking page lets clients optionally request a technician when submitting an inquiry. The request flows into your inbox so you can honor it on confirmation — perfect for retaining loyal clients.",
  },
  {
    q: "Can I store nail color formulas or polish preferences per client?",
    a: "Each client profile has a notes field where you can record any details — preferred polish brands, nail length, allergies, design preferences, or anything your techs need to know before the appointment.",
  },
  {
    q: "How long does setup take for a small nail salon?",
    a: "Most nail salons are up and running in under 10 minutes — add your services with prices and durations, invite your techs, set your public URL, and you can accept inquiries right away.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs font-semibold mb-6">
          ...
          Built for nail salons and nail techs
        </div>
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Schedule manis, pedis, gel sets, and nail art with the right technician — every time. Take bookings from your dashboard or your public page, and keep client preferences on file.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            The nail salon stack — without the chaos
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From walk-in pedis to detailed nail art, Smapey handles every booking type your studio runs.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Run your nail salon on autopilot
        </h2>
        <p className="text-white/40 mb-8">Free for life. Setup takes minutes. No card needed.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function NailSalonManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/nail-salon-management-software" />
      <Footer />
    </main>
  )
}
