...
import {
  Sparkles, Users, Scissors, Globe, Inbox, BarChart3,
  CheckCircle2, ChevronRight, Menu, X, Zap, XCircle, Flower2,
} from "lucide-react"
...
const FEATURES = [
  {
    icon: Sparkles,
    title: "One Catalog for Salon + Spa",
    desc: "Manage haircuts, color treatments, facials, massages, and packages from a single service list. Each item carries its own price, duration, and assigned staff.",
    color: "from-pink-600 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Scissors,
    title: "Stylist & Therapist Assignment",
    desc: "Assign appointments to the right specialist — colorist, barber, esthetician, or massage therapist. Clients can request a preferred staff member on the booking page.",
    color: "from-rose-600 to-pink-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: Flower2,
    title: "Treatment Sessions & Packages",
    desc: "Define multi-step spa treatments with the right duration and price. Clients see total session length on their booking confirmation so they plan their day properly.",
    color: "from-fuchsia-600 to-pink-400",
    shadow: "shadow-fuchsia-500/20",
  },
  {
    icon: Globe,
    title: "Public Booking Page for Both",
    desc: "Get a unique URL your clients visit to browse every service you offer — salon and spa. Share it on Instagram, Google Maps, or your front desk QR code.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Inbox,
    title: "Inquiries & Deposits",
    desc: "Booking inquiries arrive in one inbox. Require a deposit before confirming high-value spa appointments, with a built-in QR code and reference number field.",
  ...
  },
  {
    ...
    desc: "See which side of the business is performing — salon revenue, spa revenue, top-booked services, and pending inquiries — all from your main dashboard.",
...
const COMPARISON = [
  ...
  { feature: "Services (salon + spa)", free: "5", pro: "20", enterprise: "Unlimited" },
  { feature: "Team members", free: "2", pro: "5", enterprise: "Unlimited" },
  { feature: "Public booking page", free: true, pro: true, enterprise: true },
  { feature: "Deposit tracking", free: false, pro: true, enterprise: true },
  { feature: "Revenue analytics", free: true, pro: true, enterprise: true },
  { feature: "Priority support", free: false, pro: false, enterprise: true },
]

const FAQS = [
  {
    q: "Can I really run my salon and spa from the same account?",
    a: "Yes — Smapey was designed for owners who do both. Add hair, nail, makeup, facial, and massage services to one service catalog. Each appointment can be assigned to the right staff member, and you'll see combined or filtered revenue on the dashboard.",
  },
  {
    q: "How do I handle different staff for salon vs spa?",
    a: "You can add as many team members as your plan allows and assign appointments to any of them. Clients can also request a preferred therapist or stylist when submitting an inquiry through your public booking page.",
  },
  {
    q: "Can I require a deposit for spa treatments but not for haircuts?",
    a: "Deposit settings are configured per organization, with a QR code and required reference number on your booking page. You can toggle deposits on or off, and set an amount that makes sense for your business mix.",
  },
  {
    q: "Is the free plan enough for a small salon-spa combo?",
    a: "The free plan supports up to 50 appointments per month, 5 services, and 2 team members — enough for a solo stylist or a small studio just getting started. Upgrade to Pro when you outgrow it.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs font-semibold mb-6">
          ...
          All-in-one salon and spa platform
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-rose-400 to-fuchsia-400">
            built for owners who run both
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Manage hair appointments, spa treatments, packages, staff, and a public booking page — all from one dashboard. No spreadsheets. No double-booking. No bloat.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            One platform. Salon + spa. Zero compromise.
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From walk-in haircuts to 90-minute body treatments — Smapey handles every booking type in your business.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Run your salon and spa from one platform
        </h2>
        <p className="text-white/40 mb-8">No card, no trial, no catch. Free forever for small salons and spa studios.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function SalonAndSpaManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/salon-and-spa-management-software" />
      <Footer />
    </main>
  )
}
