...
import {
  Calendar, Inbox, CheckCircle, Clock, Users, BarChart3,
...
const FEATURES = [
  {
    icon: Calendar,
    title: "Full Appointment Scheduler",
    desc: "Create and manage every salon appointment from your dashboard. Set date, time, service, and assigned staff — all in a few taps.",
    color: "from-pink-600 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Inbox,
    title: "Online Inquiry Pipeline",
    desc: "Clients submit booking inquiries through your public booking page. All requests land in your Inquiries tab — review, accept, or decline in one click.",
  ...
  },
  {
    ...
    desc: "Every appointment moves through clear statuses: Booked → In Progress → Completed. Know exactly where every client is at any moment.",
  ...
  },
  {
    ...
    desc: "See all appointments for the day in chronological order. Filter by staff member or service type. Never double-book a slot again.",
  ...
  },
  {
    ...
    desc: "Every appointment is linked to a client profile. View a client's full booking history, preferences, and contact details before each appointment.",
  ...
  },
  {
    ...
    desc: "Track how many appointments were booked, completed, and cancelled each month. Spot your busiest days and most popular services.",
...
const FAQS = [
  {
    q: "How does the inquiry-to-appointment flow work?",
    a: "Clients visit your public booking page and submit a booking inquiry with their preferred service, date, and time. The inquiry appears in your Inquiries tab. You review it, accept it, and it converts into a confirmed appointment automatically.",
  },
  {
    q: "Can clients book directly without me approving?",
    a: "Currently, all bookings go through an inquiry flow where you confirm the appointment. This gives you full control over your schedule and prevents conflicts.",
  },
  {
    q: "What appointment statuses are available?",
    a: "Appointments move through three statuses: Booked (confirmed), In Progress (client is currently being served), and Completed (service is done and payment recorded).",
  },
  {
    q: "Can I see all appointments for the week at once?",
    a: "Yes. The appointment dashboard gives you a full list view that you can filter by date range, staff member, or service type — so you can plan ahead and avoid scheduling conflicts.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The salon appointment manager app{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-rose-400 to-fuchsia-400">
            that never misses a booking
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Schedule appointments, accept booking inquiries online, track statuses from Booked to Completed, and see your full daily schedule — all from one clean dashboard. Free to start.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Manage every appointment from one place
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From online inquiry to completed appointment — track your full booking pipeline with zero confusion.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Never miss another salon booking
        </h2>
        <p className="text-white/40 mb-8">Free to start. No credit card. Your salon appointment manager is ready in minutes.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function SalonAppointmentManagerAppContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/salon-appointment-manager-app" />
      <Footer />
    </main>
  )
}
