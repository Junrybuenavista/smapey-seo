...
import {
  Users, UserCheck, Scissors, Globe, Inbox, BarChart3, Calendar,
...
const FEATURES = [
  {
    icon: UserCheck,
    title: "Add Staff in Seconds",
    desc: "Add every stylist, colorist, and receptionist as a team member. Each gets their own login, role, and permissions — so you control exactly what they see.",
    color: "from-pink-600 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Calendar,
    title: "Per-Staff Appointment Assignment",
    desc: "Assign every booking to the right stylist. Filter the appointment list by staff member to see who's busy today and who has open slots for walk-ins.",
  ...
  },
  {
    ...
    desc: "Owners see everything — revenue, settings, and the full team. Members see only their schedule and assigned clients. No accidental data exposure.",
    color: "from-fuchsia-600 to-pink-400",
    shadow: "shadow-fuchsia-500/20",
  },
  {
    icon: Globe,
    title: "Client-Requested Staff",
    desc: "On your public booking page, clients can request their favorite stylist. The request flows into the inquiry so you can honor it — or reassign if needed.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Inbox,
    title: "Shared Inquiry Pipeline",
    desc: "All booking inquiries land in one inbox. Any staff with permission can review, approve, or convert them into appointments — no front-desk bottleneck.",
  ...
  },
  {
    ...
    desc: "See completed appointments per staff member, total revenue, and pending inquiries. Identify your top performers without digging through spreadsheets.",
...
const COMPARISON = [
  ...
  { feature: "Per-staff appointment view", free: true, pro: true, enterprise: true },
  { feature: "Role-based permissions", free: true, pro: true, enterprise: true },
  { feature: "Client-requested staff", free: true, pro: true, enterprise: true },
  { feature: "Staff performance analytics", free: false, pro: true, enterprise: true },
...
const FAQS = [
  {
    ...
    a: "The free plan supports 2 team members — perfect for a solo stylist with a receptionist. Pro supports 5, and Enterprise is unlimited for multi-chair salons or chains.",
  },
  {
    q: "Can each staff member see only their own appointments?",
    a: "Yes. Team members with the MEMBER role see only what they're assigned to. Owners and admins see the full schedule, revenue, and team. You control access through user roles.",
  },
  {
    q: "Do my staff need their own logins?",
    a: "Yes. Each team member gets their own email + password login, which keeps your activity log clean and prevents anyone from accidentally overwriting another stylist's work.",
  },
  {
    q: "Can I track which stylist generated the most revenue?",
    a: "Pro and Enterprise plans surface per-staff revenue and appointment counts on the dashboard, so you can spot top performers, plan commissions, or balance the workload.",
  },
]
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-rose-400 to-fuchsia-400">
            that respects your team
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Add staff, assign appointments, control access by role, and see who's performing — all from a single dashboard built for small salons.
        </p>
    ...
    <section className="py-24 bg-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          <p className="text-pink-600 text-sm font-semibold uppercase tracking-widest mb-3">Team Features</p>
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Everything you need to manage your salon staff
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From hiring your first stylist to running a multi-chair salon — Smapey handles the team side of your business.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Bring your whole salon team into one app
        </h2>
        <p className="text-white/40 mb-8">No card, no trial. Free forever for small salon teams.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function SalonEmployeeManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/salon-employee-management-software" />
      <Footer />
    </main>
  )
}
