...
import {
  Package, Scissors, Globe, Inbox, BarChart3, Calendar, Users,
  CheckCircle2, ChevronRight, Menu, X, Zap, XCircle, Boxes,
} from "lucide-react"
...
const FEATURES = [
  {
    icon: Boxes,
    title: "Service Catalog as Inventory",
    desc: "Every service, treatment, and add-on lives in one catalog with its own price, duration, and image. Update once — your booking page and dashboard stay in sync.",
    color: "from-pink-600 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Package,
    title: "Price & Duration Tracking",
    desc: "Set the price and time for each service. Knowing how long a treatment takes — and what it costs — gives you a foundation for inventory planning and consumption.",
    color: "from-rose-600 to-pink-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: Calendar,
    title: "Consumption by Appointment",
    desc: "See which services have been booked this month and how often. Use the data to plan product reorders — color, shampoo, conditioner, nail polish, anything.",
  ...
  },
  {
    ...
    desc: "Dashboard shows total revenue and appointment count per service. The high-volume items are the ones you must keep stocked — no guesswork involved.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Users,
    title: "Per-Staff Service Mix",
    desc: "Each stylist's bookings show which services they perform most. Helpful for inventory allocation — your colorist needs different supplies than your barber.",
    color: "from-rose-500 to-fuchsia-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: Globe,
    title: "Public Service Menu",
    desc: "Your service list doubles as your public booking page. Clients see your full menu with prices and durations — the same data that drives your inventory view.",
...
const COMPARISON = [
  ...
  { feature: "Appointments / month", free: "30", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Service photos", free: true, pro: true, enterprise: true },
  { feature: "Revenue analytics", free: true, pro: true, enterprise: true },
  { feature: "Service-level reports", free: false, pro: true, enterprise: true },
...
const FAQS = [
  {
    q: "Does Smapey track product inventory like shampoo or color tubes?",
    a: "Smapey tracks your service catalog and how often each service is booked. Most small salons use this consumption data to plan their product reorders — it's lighter than full SKU tracking, but it covers the use case for solo and small-team salons.",
  },
  {
    q: "Can I see which services are most popular?",
    a: "Yes. The dashboard shows total revenue, appointment count, and completion rate. You can identify your highest-volume services at a glance and use that to plan your inventory and your team's training.",
  },
  {
    q: "How many services can I store?",
    a: "The free plan supports up to 10 services, Pro supports 50, and Enterprise is unlimited. Each service can include a photo, description, price, and duration.",
  },
  {
    q: "Can I update prices across all services at once?",
    a: "Each service is edited individually so you have full control over pricing changes. Updates take effect immediately on your public booking page and dashboard.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs font-semibold mb-6">
          ...
          Service catalog · pricing · consumption
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-rose-400 to-fuchsia-400">
            for service-first businesses
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Track your service catalog, prices, and consumption alongside your appointments. Built for salons that want clear data without enterprise complexity.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Inventory thinking for service-based salons
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Track what matters: services, prices, consumption, and revenue. The data you need without the SKU overhead.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Know your services. Know your numbers.
        </h2>
        <p className="text-white/40 mb-8">Free for life. Track your salon's service catalog without a single spreadsheet.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function SalonInventoryManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/salon-inventory-management-software" />
      <Footer />
    </main>
  )
}
