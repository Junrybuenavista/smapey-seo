...
const FEATURES = [
  {
    ...
    desc: "Create, update, and track every salon appointment from a single dashboard. See the full day's schedule at a glance and manage last-minute changes with ease.",
  ...
  },
  {
    ...
    desc: "Store full client profiles including contact details, appointment history, and service preferences. Search by name or phone to pull up any client instantly.",
  ...
  },
  {
    ...
    desc: "Define every service you offer — name, price, and duration. Your catalogue drives both your appointment booking and your public-facing booking page.",
  ...
  },
  {
    ...
    desc: "Every salon gets a unique URL. Clients visit your page, browse your services, and submit a booking inquiry — no phone call required.",
  ...
  },
  {
    ...
    desc: "Incoming booking requests land in your Inquiries tab. Review, accept, or decline each one. Accepted inquiries become confirmed appointments automatically.",
  ...
  },
  {
    ...
    desc: "See monthly revenue, appointment volume, and completion rate on your main dashboard. Know your numbers without opening a spreadsheet.",
...
const FAQS = [
  {
    q: "What makes Smapey different from other salon management apps?",
    a: "Smapey focuses on the essentials — appointments, clients, services, and a public booking page — without the complexity of large enterprise tools. It's built for small salons that need to get started quickly and affordably.",
  },
  {
    q: "How does the public booking page work?",
    a: "Every salon account gets a unique URL. When clients visit the page, they see your service menu and can submit a booking inquiry with their preferred date and time. You review and confirm the booking in your dashboard.",
  },
  {
    q: "Can I manage staff with the app?",
    a: "Yes. You can add team members and assign appointments to specific staff. The free plan supports 2 team members. The Pro plan supports up to 5.",
  },
  {
    q: "Is the free plan really free forever?",
    a: "Yes. The free plan has no time limit. It supports up to 50 appointments per month, 5 services, and 2 team members. You only need to upgrade when your volume grows.",
  },
]
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Complete salon management in one place
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From the first client inquiry to the final payment — SalonOS handles your entire operation.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Start managing your salon for free
        </h2>
        <p className="text-white/40 mb-8">No card, no trial, no catch. A salon management app that works from day one.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function SalonManagementAppContent() {
  return (
    <main>
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/salon-management-app" />
      <Footer />
    </main>
  )
}
