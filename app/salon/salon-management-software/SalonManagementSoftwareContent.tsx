...
const FEATURES = [
  {
    ...
    desc: "Take bookings from your dashboard or your public booking page. Every appointment is timestamped, assigned to a staff member, and tracked from booked to completed.",
  ...
  },
  {
    ...
    desc: "Every client gets a profile — contact details, visit history, notes, and preferred services. Search by name or phone to pull up any record instantly.",
  ...
  },
  {
    ...
    desc: "Define every service with a price, duration, and photo. Your catalog drives both your in-house booking screen and your public booking page.",
  ...
  },
  {
    ...
    desc: "Each salon gets a branded URL clients can visit to browse services and submit booking requests — no app download, no phone tag.",
  ...
  },
  {
    ...
    desc: "Booking requests land in a single inbox. Accept or decline each one in a click; accepted requests automatically become confirmed appointments.",
  ...
  },
  {
    ...
    desc: "Monthly revenue, appointment volume, and completion rate update in real time. Know your numbers without exporting spreadsheets.",
...
const FAQS = [
  {
    ...
    a: "Salon management software replaces the paper appointment book and spreadsheet client list with a single web app. Smapey handles bookings, clients, services, team, and a public booking page — everything you need to run a small salon end-to-end.",
  },
  {
    q: "How is Smapey different from other salon software?",
    a: "Smapey focuses on the essentials small salons actually use — appointments, clients, services, and a booking page — without enterprise complexity or pricing. You can sign up, set up your services, and accept your first booking in minutes.",
  },
  {
    q: "Do I need to install anything?",
    a: "No. Smapey runs entirely in your browser. Sign in from your phone, tablet, or laptop and your data is always in sync. No installation, no servers, no IT setup.",
  },
  {
    q: "Is the free plan really free forever?",
    a: "Yes. The free plan has no expiration and supports up to 50 appointments per month, 10 services, and 2 team members. Upgrade only when your salon outgrows those limits.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs font-semibold mb-6">
          ...
          Complete salon management — one platform
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          The salon management software{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-rose-400 to-fuchsia-400">
            that just works
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Appointments, clients, services, team, and a public booking page — every essential in one clean dashboard. No bloat, no learning curve, no spreadsheets.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            From the first client inquiry to the final payment, SalonOS covers your entire operation.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Salon management software, free forever
        </h2>
        <p className="text-white/40 mb-8">No card, no trial, no catch. Start managing your salon in under five minutes.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function SalonManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/salon-management-software" />
      <Footer />
    </main>
  )
}
