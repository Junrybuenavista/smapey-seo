...
import {
  Building2, Users, Scissors, Globe, Inbox, BarChart3, Key, Calendar,
...
const FEATURES = [
  {
    ...
    desc: "Booth renters and suite owners get a unique URL with your name, photo, services, and branding — not your suite operator's. Your clients book you directly.",
    color: "from-pink-600 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Key,
    title: "Independent Service Catalog",
    desc: "Set your own prices, services, and durations — completely separate from anyone else in the building. Update them anytime; your booking page updates instantly.",
  ...
  },
  {
    ...
    desc: "Run your own calendar — block out personal time, set working hours, accept or decline inquiries. No central front desk deciding when you can take a break.",
    color: "from-fuchsia-600 to-pink-400",
    shadow: "shadow-fuchsia-500/20",
  },
  {
    icon: Globe,
    title: "Public Booking from Your Bio",
    desc: "Drop your Smapey booking URL into your Instagram bio. Clients see your services, send inquiries, and pay deposits — all without leaving the platform.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Inbox,
    title: "Client Records You Own",
    desc: "Build your client list inside your own account. Notes, history, and preferences stay with you — even if you move to a new suite.",
    color: "from-rose-500 to-fuchsia-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: BarChart3,
    title: "Your Revenue, Your Reports",
    desc: "Track exactly what you earned this month, how many appointments you completed, and which services are growing. Built for independent stylists running their own business.",
...
const COMPARISON = [
  { feature: "Branded booking page", free: true, pro: true, enterprise: true },
  { feature: "Your own service catalog", free: "10", pro: "50", enterprise: "Unlimited" },
  { feature: "Appointments / month", free: "50", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Client records", free: true, pro: true, enterprise: true },
  { feature: "Deposit collection", free: false, pro: true, enterprise: true },
  { feature: "Revenue reports", free: true, pro: true, enterprise: true },
  { feature: "Priority support", free: false, pro: false, enterprise: true },
]

const FAQS = [
  {
    q: "Is Smapey built for salon suite owners and booth renters?",
    a: "Smapey works perfectly for independent stylists in suite or booth setups. You run your own account, your own branding, your own service catalog, and your own booking page — completely separate from whoever owns the building.",
  },
  {
    q: "Can my client list move with me if I switch suites?",
    a: "Yes. Your client records live in your Smapey account, not the building's system. If you move to a new suite or even a new city, your client list, history, and notes come with you.",
  },
  {
    q: "Do I need to share access with my suite operator?",
    a: "No. Your Smapey account is yours. You decide who has login access — usually just you, or you and an assistant. Your suite operator has no visibility into your bookings or revenue unless you explicitly add them.",
  },
  {
    q: "Can I collect deposits through my own QR code?",
    a: "Yes. The Pro plan lets you upload your own GCash or bank QR code on your booking page, with a required reference number field — so deposits flow straight to your account, not the suite operator's.",
  },
]
    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden"
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs font-semibold mb-6">
          ...
          Built for booth renters and suite owners
        </div>
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          Salon suite management software{" "}
        ...
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Your own booking page. Your own services. Your own client list. Run your suite or booth like the business it is — and keep everything portable if you ever move.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Everything an independent stylist needs to look professional and stay flexible.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Run your suite like the business it is
        </h2>
        <p className="text-white/40 mb-8">Free forever. No card. Take your bookings, clients, and brand with you wherever you go.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function SalonSuiteManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/salon-suite-management-software" />
      <Footer />
    </main>
  )
}
