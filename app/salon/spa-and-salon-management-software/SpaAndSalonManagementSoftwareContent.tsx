...
import {
  Flower2, Users, Scissors, Globe, Inbox, BarChart3, Sparkles, Heart,
...
const FEATURES = [
  {
    icon: Flower2,
    title: "Spa Treatment Catalog",
    desc: "Facials, massages, body treatments, packages — define every spa service with its true session length and price. Clients see what to expect before they book.",
  ...
  },
  {
    ...
    desc: "Add hair, color, makeup, and nail services alongside your spa menu. One unified catalog means one place to update prices and durations.",
    color: "from-rose-600 to-pink-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: Heart,
    title: "Client Notes for Both Sides",
    desc: "Store hair color formulas next to spa intake notes — allergies, pressure preferences, skin sensitivities. One profile per client, no juggling apps.",
    color: "from-fuchsia-600 to-pink-400",
    shadow: "shadow-fuchsia-500/20",
  },
  {
    icon: Globe,
    title: "Unified Booking Page",
    desc: "One branded URL displays every service you offer. Clients pick a treatment or appointment and submit their inquiry — no switching tools.",
    color: "from-pink-500 to-rose-400",
    shadow: "shadow-pink-500/20",
  },
  {
    icon: Inbox,
    title: "Deposit Flow for Spa Bookings",
    desc: "Require a deposit for premium treatments while keeping quick haircuts no-deposit. Built-in QR code and reference field on your public booking page.",
    color: "from-rose-500 to-fuchsia-400",
    shadow: "shadow-rose-500/20",
  },
  {
    icon: BarChart3,
    title: "Combined Revenue Insight",
    desc: "See which side of the business is performing — spa revenue, salon revenue, top services. Plan your week, your inventory, and your team accordingly.",
...
const COMPARISON = [
  { feature: "Spa + salon services", free: "10", pro: "50", enterprise: "Unlimited" },
  { feature: "Appointments / month", free: "50", pro: "Unlimited", enterprise: "Unlimited" },
  { feature: "Stylists + therapists", free: "2", pro: "5", enterprise: "Unlimited" },
  ...
  { feature: "Combined analytics", free: true, pro: true, enterprise: true },
  { feature: "Priority support", free: false, pro: false, enterprise: true },
]

const FAQS = [
  {
    q: "Can I run my spa and salon from one Smapey account?",
    a: "Yes — that's exactly what spa-and-salon owners use Smapey for. Add hair, facial, massage, nail, and treatment services to a single catalog, assign each booking to the right specialist, and see combined or filtered revenue on your dashboard.",
  },
  {
    q: "How does spa-style deposit collection work?",
    a: "You toggle deposits on for your organization, upload your GCash or bank QR code, and set a required reference number field. Clients booking premium treatments see the QR on the booking page and must enter a reference number before submitting.",
  },
  {
    q: "Can therapists and stylists have separate logins?",
    a: "Yes. Each team member — therapist or stylist — gets their own login with role-based access. Pro supports 5 team members, Enterprise is unlimited. Members only see their own assigned appointments.",
  },
  {
    q: "Is Smapey enough for a luxury spa with 20+ services?",
    a: "The Pro plan supports up to 50 services, which covers virtually every full-service spa. Enterprise removes all limits if your menu is larger or you run multiple branches.",
  },
]
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight tracking-tight mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-rose-400 to-fuchsia-400">
            for full-service beauty businesses
          </span>
        </h1>
        <p className="text-lg text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Whether you offer haircuts, massages, facials, or all of the above — manage every booking, deposit, and client preference from one elegant dashboard.
        </p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-800 tracking-tight">
            Spa-first features. Salon-grade speed.
          </h2>
          <p className="text-slate-500 mt-4 max-w-xl mx-auto">
            Built for businesses that take treatments seriously — without slowing down the rest of your salon day.
          </p>
        </Animate>
    ...
    <section className="py-24 relative overflow-hidden"
      ...
      <Animate className="relative max-w-2xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mb-4">
          Spa + salon, finally in one app
        </h2>
        <p className="text-white/40 mb-8">Free for life. No card, no trial. Manage treatments and appointments side by side.</p>
        <a href={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/register?product=SALON&plan=FREE`}
...
export default function SpaAndSalonManagementSoftwareContent() {
  return (
    <main>
      <Navbar />
      <Hero />
      ...
      <FAQ />
      <CTA />
      <InternalLinks cluster="salon" currentPath="/salon/spa-and-salon-management-software" />
      <Footer />
    </main>
  )
}
