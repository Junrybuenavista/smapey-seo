    ...
    <section id="pricing" className="py-24" style={{ background: "#fff", fontFamily: display.fontFamily }}>
      <div className="max-w-6xl mx-auto px-6">
        <Animate className="text-center mb-16">
          ...
          <p className="mt-4" style={{ color: "#54514c" }}>Start free. Upgrade as your station grows.</p>
          {isPhilippines !== null && (
...
// CTA
//////////////////////////////////////////////////////
export function CTA({ title = "Ready to run your station smarter?", subtitle = "Join station owners who use Smapey to track orders, containers, inventory, and payments - without notebooks or guesswork." }: { title?: string; subtitle?: string }) {
  return (
    ...
    <footer className="px-6 py-8" style={{ background: CREAM, borderTop: `2px solid ${INK}`, fontFamily: display.fontFamily }}>
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-5 text-xs font-semibold">
          <a href="/water-refilling" className="hover:opacity-60 transition-opacity" style={{ color: "#9a948b" }}>Overview</a>
          <a href="/water-refilling/guide" className="hover:opacity-60 transition-opacity" style={{ color: "#9a948b" }}>Guide</a>
...
export function HeroBadge({ children }: { children: React.ReactNode }) {
  return (
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border-2 text-xs font-bold mb-6" style={{ color: INK, borderColor: INK, boxShadow: `3px 3px 0 ${BLUE}` }}>
      <Droplets className="w-3.5 h-3.5" style={{ color: BLUE }} />{children}
    </div>
  )
}
  ...
  return (
    <div className="my-12 rounded-[24px] border-2 p-8" style={{ background: CREAM, borderColor: INK, boxShadow: `8px 8px 0 ${BLUE}` }}>
      <div className="flex items-start gap-4">
        ...
        <div>
          <h3 className="text-xl font-extrabold mb-2" style={{ color: INK }}>Run your station with Smapey Water Refilling</h3>
