...
export const CLUSTERS: Record<ClusterKey, RouteCluster> = {
  ...
  salon: {
    ...
    pages: [
      ...
      { path: "/salon/salon-and-spa-management-software", title: "Salon and Spa Management Software", desc: "All-in-one platform for salons and spas — bookings, clients, payments, and a public booking page." },
      { path: "/salon/salon-employee-management-software", title: "Salon Employee Management Software", desc: "Manage staff, assign appointments, and track team performance from one dashboard." },
      { path: "/salon/salon-inventory-management-software", title: "Salon Inventory Management Software", desc: "Track services, pricing, and consumption alongside your appointments and team." },
      { path: "/salon/salon-management-software", title: "Salon Management Software", desc: "The complete salon management software — bookings, clients, services, team, and analytics in one app." },
      { path: "/salon/nail-salon-management-software", title: "Nail Salon Management Software", desc: "Booking, technician assignment, and client history built for nail salons and nail studios." },
      { path: "/salon/beauty-salon-management-software", title: "Beauty Salon Management Software", desc: "Beauty salon software for stylists, colorists, and beauticians — appointments, clients, and a public booking page." },
      { path: "/salon/best-salon-management-software", title: "Best Salon Management Software", desc: "Why Smapey is the best salon management software for small salons — features, pricing, and an honest comparison." },
      { path: "/salon/spa-and-salon-management-software", title: "Spa and Salon Management Software", desc: "Spa-led platform for full-service beauty businesses running treatments, packages, and salon appointments together." },
      { path: "/salon/salon-suite-management-software", title: "Salon Suite Management Software", desc: "Booth renters and salon suite owners — manage independent stylists, suite rentals, and bookings in one app." },
      { path: "/salon/cloud-based-salon-management-software", title: "Cloud-Based Salon Management Software", desc: "Access your salon from anywhere — no installs, no servers, automatic backups. Modern cloud-based management." },
    ],
  },
}
